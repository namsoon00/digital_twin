...
- Do not put API keys, Telegram tokens, client secrets, raw account credentials, local MySQL dumps, legacy `data/store.json`, legacy `data/settings.json`, legacy `data/domain-events.jsonl`, or other private local data into git.
