...
새 모바일 앱은 `mobile/`에 있습니다. 한국/미국 시장 흐름, 세계 자금 흐름, 테마 확산, 관심 종목, 투자 전 체크리스트, 감 기록을 보는 Flutter MVP입니다.
...
`체크` 탭은 투자하기 전 확인할 기본 체크리스트, 날짜별 메모, 사용자 추가 항목, 월간 캘린더 상태를 관리합니다. 체크 상태와 메모는 기기 로컬 설정에 저장되어 날짜별로 다시 볼 수 있습니다.
