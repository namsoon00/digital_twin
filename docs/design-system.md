...
전문 금융앱 같은 룩앤필은 장식이 아니라 안정감, 예측 가능성, 빠른 비교에서 나온다. Orbit Alpha는 Soft Graphite 톤을 기본으로 쓰되, 브랜드 모티프는 중앙 코어, 얇은 궤도선, 작은 신호점으로 제한한다. 토스처럼 저채도 회색 표면, 흰 카드, 차콜 텍스트, 파란 주요 액션, 녹색/빨간색 상태색만 제한적으로 쓴다.
