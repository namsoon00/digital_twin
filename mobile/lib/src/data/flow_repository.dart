...
abstract class FlowRepository {
  ...
  List<CryptoAsset> get cryptoAssets;
...
class MockFlowRepository implements FlowRepository {
  ...
  @override
  List<FlowCandle> get globalFlowCandles => const [
    FlowCandle(
      label: 'W01',
      open: 54,
      high: 58,
  ...
  @override
  List<CryptoAsset> get cryptoAssets => const [
    CryptoAsset(
      id: 'bitcoin',
      symbol: 'BTC',
      name: 'Bitcoin',
    ...
    CryptoAsset(
      ...
      rank: 2,
      priceUsd: 3620,
      marketCapUsd: 436000000000,
      volume24hUsd: 23000000000,
      change1hPercent: 0.1,
