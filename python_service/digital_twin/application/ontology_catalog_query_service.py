...
class OntologyCatalogQueryService:
    ...
    def normalize_rule(self, raw: Mapping[str, object]) -> Dict[str, object]:
        ...
        return {
            ...
            "triggerEventClasses": list_values(manifest.get("triggerEventClasses")),
            "evaluationGrain": text(manifest.get("evaluationGrain")),
            "ownerWorld": text(manifest.get("ownerWorld")),
            "executionCadence": text(manifest.get("executionCadence")),
            "incrementalEligible": bool(manifest.get("incrementalEligible")),
            "executionUnit": item_dict(manifest.get("executionUnit")),
    ...
    def rule_list_item(row: Mapping[str, object]) -> Dict[str, object]:
        ...
        return {
            ...
            for key in [
                ...
                "triggerEventClasses", "evaluationGrain", "ownerWorld", "executionCadence",
                "incrementalEligible",
