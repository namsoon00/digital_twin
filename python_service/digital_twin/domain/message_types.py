...
TRIGGER_SUMMARIES = {
    MODEL_BUY: "내 매수 모델 점수가 기준을 넘을 때 보냅니다.",
    MODEL_SELL: "내 매도 모델 점수가 기준을 넘을 때 보냅니다.",
    ...
    MONITOR_PNL_CHANGE: "직전 스냅샷 대비 손익률 변화가 임계값을 넘을 때 보냅니다.",
    MONITOR_VALUE_CHANGE: "직전 스냅샷 대비 평가액 변화가 임계값을 넘을 때 보냅니다.",
    MONITOR_TREND_CHANGE: "이동평균 돌파, 크로스, 큰 괴리가 감지될 때 보냅니다.",
    MONITOR_CASH_CHANGE: "시장별 현금 비중 변화가 임계값을 넘을 때 보냅니다.",
    MONITOR_DECISION_CHANGE: "종목 판단이나 리스크 점수가 바뀔 때 보냅니다.",
    EXTERNAL_EQUITY_MOVE: "Alpha Vantage 기준 미국 보유 종목의 가격 변화가 임계값을 넘을 때 보냅니다.",
    EXTERNAL_CRYPTO_MOVE: "CoinGecko 기준 크립토 가격 변화가 임계값을 넘을 때 보냅니다.",
    EXTERNAL_MACRO_SHIFT: "FRED 금리·스프레드 변화가 임계값을 넘을 때 보냅니다.",
