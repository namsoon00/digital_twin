...
DECISION_STAGE_DEFINITIONS = {
    ...
    "TEMPORAL_RISK": DecisionStageDefinition("TEMPORAL_RISK", "temporalRisk", "review", "기간 리스크 점검", "caution", 55.0, 70.0),
    "TEMPORAL_ACTION": DecisionStageDefinition("TEMPORAL_ACTION", "temporalRisk", "action", "기간 리스크 대응 점검", "danger", 70.0, 85.0),
    "TEMPORAL_DEFENSE": DecisionStageDefinition("TEMPORAL_DEFENSE", "temporalDefense", "review", "기간 방어 근거 점검", "watch", 55.0, 70.0),
    ...
    "VALUATION_REVIEW": DecisionStageDefinition("VALUATION_REVIEW", "valuation", "review", "밸류에이션 점검", "watch", 55.0, 70.0),
    "VALUATION_OPPORTUNITY": DecisionStageDefinition("VALUATION_OPPORTUNITY", "valuation", "review", "저평가 조건 확인", "watch", 55.0, 70.0),
    "VALUATION_RISK": DecisionStageDefinition("VALUATION_RISK", "valuation", "review", "고평가 부담 점검", "caution", 55.0, 70.0),
...
DEFAULT_RELATION_RULES = [
    ...
    RelationRuleDefinition(
        ...
        ["windowKey", "pricePathPattern", "ma20DistanceStart", "ma20DistanceEnd", "temporalRiskScore"],
    ),
    RelationRuleDefinition(
        ...
        ["windowKey", "pricePathPattern", "flowPattern", "temporalSupportScore"],
    ),
    RelationRuleDefinition(
        ...
        ["windowKey", "eventClusterType", "riskEventCount", "temporalRiskScore"],
    ),
    RelationRuleDefinition(
        "breakout.failure.v1",
        "회복/돌파 후 재이탈 -> 실패 리스크",
