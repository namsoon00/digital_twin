...
CLASS_DEFS: List[TBoxClassDef] = [
    ...
    TBoxClassDef("ValuationConfidence", "strategy-thesis", "밸류에이션 신뢰도", parent="ValuationAssumption", description="출처, 입력 충족률, 기준일, 기간 일치 여부를 합친 계산 신뢰도입니다."),
...
RELATION_DEFS: List[TBoxRelationDef] = [
    ...
    TBoxRelationDef("HAS_VALUATION_CONFIDENCE", "strategy-thesis", "investment-core", "strategy-thesis", "종목이 밸류에이션 데이터 품질과 판단 사용 가능 상태에 연결됩니다."),
