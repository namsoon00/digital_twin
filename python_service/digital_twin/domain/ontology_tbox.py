...
CLASS_DEFS: List[TBoxClassDef] = [
    ...
    TBoxClassDef("MarketProxyInstrument", "investment-core", "시장 프록시 종목", parent="Instrument", description="경제 흐름, 시장 심리, 금리, 크레딧, 원자재, 섹터 사이클을 관찰하기 위한 대표 거래 대상입니다."),
    ...
    TBoxClassDef("CrossListedSecurity", "strategy-thesis", "교차 상장 투자 타입", parent="InvestmentArchetype", description="본주와 ADR·GDR처럼 여러 시장 거래 라인을 통해 가격 괴리와 환율 노출이 생기는 타입입니다."),
    TBoxClassDef("DailyLeveragedProduct", "strategy-thesis", "일일 레버리지 상품 타입", parent="InvestmentArchetype", description="일일 리셋 구조 때문에 장기 보유보다 단기 수급과 변동성 확인이 중요한 상품 타입입니다."),
    TBoxClassDef("InverseProduct", "strategy-thesis", "인버스 상품 타입", parent="InvestmentArchetype", description="기초자산의 반대 방향 성과를 추구해 헤지와 투기 수요를 분리해야 하는 상품 타입입니다."),
    TBoxClassDef("BroadMarketProxy", "strategy-thesis", "광범위 시장 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("CommodityProxy", "strategy-thesis", "원자재 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("CreditStressProxy", "strategy-thesis", "크레딧 스트레스 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("CryptoLiquidityProxy", "strategy-thesis", "크립토 유동성 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("CurrencyProxy", "strategy-thesis", "통화 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("DurationProxy", "strategy-thesis", "채권 듀레이션 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("ForeignMarketProxy", "strategy-thesis", "해외 시장 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("GrowthMarketProxy", "strategy-thesis", "성장주 시장 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("IPOCycleProxy", "strategy-thesis", "IPO 사이클 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("KoreaMarketProxy", "strategy-thesis", "한국 시장 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("RateSensitivityProxy", "strategy-thesis", "금리 민감도 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("RiskAppetiteProxy", "strategy-thesis", "위험자산 심리 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("RiskOffProxy", "strategy-thesis", "위험회피 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("SectorCycleProxy", "strategy-thesis", "섹터 사이클 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("SmallCapRiskProxy", "strategy-thesis", "소형주 위험선호 프록시", parent="InvestmentArchetype"),
    TBoxClassDef("VolatilityProxy", "strategy-thesis", "변동성 프록시", parent="InvestmentArchetype"),
