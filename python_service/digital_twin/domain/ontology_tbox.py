...
CLASS_DEFS: List[TBoxClassDef] = [
    ...
    TBoxClassDef("SingleStockETF", "investment-core", "단일종목 ETF", parent="LeveragedETF", description="단일 종목을 기초자산으로 삼는 ETF 거래 라인입니다."),
    TBoxClassDef("DailyResetLeverage", "investment-core", "일일 리셋 레버리지", parent="LeveragedETF", description="일별 재조정 때문에 기초자산 수급과 변동성에 영향을 줄 수 있는 레버리지 구조입니다."),
