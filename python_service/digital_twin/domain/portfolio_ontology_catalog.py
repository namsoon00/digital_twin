...
SETTING_CONCEPT_TYPES = {
    ...
    "newsCollectionQualityGateEnabled": ("CollectionPolicy", "USES_COLLECTION_POLICY"),
    "newsCollectionMinimumRelevanceState": ("CollectionPolicy", "USES_COLLECTION_POLICY"),
    "newsCollectionMinimumMaterialityState": ("CollectionPolicy", "USES_COLLECTION_POLICY"),
    "newsCollectionMinimumSourceTrustState": ("CollectionPolicy", "USES_COLLECTION_POLICY"),
    "newsCollectionRequireArticleBody": ("CollectionPolicy", "USES_COLLECTION_POLICY"),
    "newsDigestMinimumRelevanceState": ("NotificationPolicy", "HAS_NOTIFICATION_POLICY"),
    "newsDigestMinimumMaterialityState": ("NotificationPolicy", "HAS_NOTIFICATION_POLICY"),
    "newsDigestMinimumNeutralMaterialityState": ("NotificationPolicy", "HAS_NOTIFICATION_POLICY"),
    "newsDigestMinimumSourceTrustState": ("NotificationPolicy", "HAS_NOTIFICATION_POLICY"),
}
...
SECTOR_FACTORS = {
    ...
    "시장프록시": ["위험자산 심리", "시장 베타", "시장 폭"],
    "채권/금리": ["금리 민감도", "듀레이션", "유동성 환경"],
    "크레딧": ["크레딧 스프레드", "신용 위험 선호"],
    "원자재/통화": ["원자재 가격", "달러 유동성", "인플레이션 민감"],
    "한국시장": ["한국 시장 베타", "원화 유동성", "국내 위험선호"],
}
