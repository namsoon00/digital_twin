        ...
        "pages": [
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {"key": "ontologyScopedFullReconcileMinutes", "label": "전체 범위 재조정 점검 주기", "type": "number", "default": "30", "unit": "minutes"},
                    {"key": "ontologyScopedFullReconcileDeferWhenQueueActive", "label": "대기열 중 전체 재조정 유예", "type": "toggle", "default": "1"},
                    {"key": "ontologyScopedFullReconcileMaxDeferralMinutes", "label": "전체 재조정 지연 표기 기준", "type": "number", "default": "60", "unit": "minutes"},
