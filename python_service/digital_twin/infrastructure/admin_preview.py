        ...
        "pages": [
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {"key": "typedbNativeRuleDirectQueryFallbackEnabled", "label": "함수 미준비 시 제한된 직접 TypeQL 추론", "type": "toggle", "default": "1"},
                    ...
                    {"key": "ontologyRuleboxPrewarmRequireReadyForInference", "label": "함수 준비 전 투자 판단 보류", "type": "toggle", "default": "0"},
                    ...
                    {"key": "ontologyRuleboxPrewarmBacklogRecoveryMinPendingEntries", "label": "함수 준비 우선 복구 최소 대기 수", "type": "number", "default": "2"},
                    {"key": "ontologyRuleboxPrewarmBacklogRecoveryRetrySeconds", "label": "함수 준비 복구 재점검", "type": "number", "default": "5", "unit": "seconds"},
                    {"key": "ontologyRuleboxPrewarmIntervalSeconds", "label": "RuleBox 함수 사전 준비 유휴 점검 주기", "type": "number", "default": "15", "unit": "seconds"},
                    {"key": "ontologyRuleboxPrewarmIdleQuietSeconds", "label": "RuleBox 함수 준비 전 큐 무활동 시간", "type": "number", "default": "300", "unit": "seconds"},
                    {"key": "ontologyRuleboxPrewarmExecutionTimeoutSeconds", "label": "RuleBox 함수 준비 유지보수 시간 상한", "type": "number", "default": "1500", "unit": "seconds"},
