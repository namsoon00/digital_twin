...
PUBLIC_SETTING_KEYS = [
    ...
    "externalEcosEnabled",
    "externalEcosTimeoutSeconds",
    "externalDataEcosCadenceSeconds",
    "externalDataEcosFreshnessSeconds",
    "externalKosisEnabled",
    "externalKosisTimeoutSeconds",
    "externalDataKosisCadenceSeconds",
    "externalDataKosisFreshnessSeconds",
    "externalKrxEnabled",
    "externalKrxTimeoutSeconds",
    "externalDataKrxCadenceSeconds",
    "externalDataKrxFreshnessSeconds",
    "externalCryptoIds",
    ...
    "externalSecDocumentMaxPerSymbol",
    "externalDartEnabled",
    ...
    "notificationAiCostControlEnabled",
    "notificationAiSubjectCooldownMinutes",
    "notificationAiSubjectDailyLimit",
    "notificationAiDailyLimit",
    "notificationAiMaxEffortDailyLimit",
    ...
    "externalBlsStatisticsEnabled",
    "informationFollowupEnabled",
    "newsCollectionGdeltRateLimitSeconds",
    "newsCollectionGdeltDailyRequestBudget",
    "externalDocumentRecoveryEnabled",
    "externalDocumentRecoveryBatchSize",
    ...
    "dartDisclosureAiReasoningEffort",
...
def configured_runtime_flags(settings: Dict[str, str]) -> Dict[str, bool]:
    return {
        ...
        "ecosApiKey": configured(settings.get("ecosApiKey")),
        "kosisApiKey": configured(settings.get("kosisApiKey")),
        "krxOpenApiKey": configured(settings.get("krxOpenApiKey")),
        "opendartApiKey": configured(settings.get("opendartApiKey")),
        "publicDataPortalServiceKey": configured(settings.get("publicDataPortalServiceKey")),
        ...
        "pages": [
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {"key": "externalAlphaRelatedSymbolsEnabled", "label": "ADR·레버리지 관련 종목 수집", "type": "toggle", "default": "1"},
                    {"key": "externalAlphaRelatedMaxSymbols", "label": "ADR·레버리지 관련 종목 수", "type": "number", "default": "8"},
                    {"key": "externalAlphaDailyRequestBudget", "label": "Alpha Vantage 일일 호출 예산", "type": "number", "default": "20"},
                    {"key": "externalAlphaQuotaCooldownMinutes", "label": "Alpha Vantage 제한 후 대기", "type": "number", "default": "1440", "unit": "minutes"},
                    ...
                    {"key": "externalYFinanceEnabled", "label": "yfinance 종합 수집", "type": "toggle", "default": "1"},
                    {"key": "externalYFinanceMaxSymbols", "label": "yfinance 조회 종목 수", "type": "number", "default": "8"},
                    {"key": "externalYFinanceHistoryPeriod", "label": "yfinance 가격 기간", "type": "text", "default": "1y"},
                    {"key": "externalYFinanceHistoryInterval", "label": "yfinance 가격 간격", "type": "text", "default": "1d"},
                    {"key": "externalYFinanceHistoryRows", "label": "yfinance 가격 행 수", "type": "number", "default": "90"},
                    {"key": "externalYFinanceFinancialPeriods", "label": "yfinance 재무제표 기간 수", "type": "number", "default": "4"},
                    {"key": "externalYFinanceTabularRows", "label": "yfinance 표 데이터 행 수", "type": "number", "default": "40"},
                    {"key": "externalYFinanceOptionExpirations", "label": "yfinance 옵션 만기 수", "type": "number", "default": "2"},
                    {"key": "externalYFinanceOptionsMaxRows", "label": "yfinance 옵션 행 수", "type": "number", "default": "40"},
                    {"key": "externalYFinanceEarningsLimit", "label": "yfinance 실적 일정 수", "type": "number", "default": "16"},
                    {"key": "externalYFinanceNewsLimit", "label": "yfinance 뉴스 수", "type": "number", "default": "10"},
                    {"key": "externalYFinancePriceMaxAgeMinutes", "label": "yfinance 가격 신선도", "type": "number", "default": "30", "unit": "minutes"},
                    {"key": "externalYFinanceOptionsMaxAgeMinutes", "label": "yfinance 옵션 신선도", "type": "number", "default": "30", "unit": "minutes"},
                    {"key": "externalYFinanceNewsMaxAgeMinutes", "label": "yfinance 뉴스 신선도", "type": "number", "default": "1440", "unit": "minutes"},
                    {"key": "externalYFinanceAnalystMaxAgeMinutes", "label": "yfinance 애널리스트 신선도", "type": "number", "default": "10080", "unit": "minutes"},
                    {"key": "externalYFinanceFundamentalMaxAgeMinutes", "label": "yfinance 재무 신선도", "type": "number", "default": "129600", "unit": "minutes"},
                    ...
                    {"key": "ecosApiKey", "label": "한국은행 ECOS 인증키", "type": "secret", "masked": True},
                    {"key": "externalEcosEnabled", "label": "ECOS 금리·환율 수집", "type": "toggle", "default": "1"},
                    {"key": "externalEcosTimeoutSeconds", "label": "ECOS 요청 시간 제한", "type": "number", "default": "10", "unit": "seconds"},
                    {"key": "externalDataEcosCadenceSeconds", "label": "ECOS 확인 주기", "type": "number", "default": "21600", "unit": "seconds"},
                    {"key": "externalDataEcosFreshnessSeconds", "label": "ECOS 유효 기간", "type": "number", "default": "172800", "unit": "seconds"},
                    {"key": "kosisApiKey", "label": "KOSIS 인증키", "type": "secret", "masked": True},
                    {"key": "externalKosisEnabled", "label": "KOSIS 산업지표 수집", "type": "toggle", "default": "1"},
                    {"key": "externalKosisTimeoutSeconds", "label": "KOSIS 요청 시간 제한", "type": "number", "default": "12", "unit": "seconds"},
                    {"key": "externalDataKosisCadenceSeconds", "label": "KOSIS 확인 주기", "type": "number", "default": "21600", "unit": "seconds"},
                    {"key": "externalDataKosisFreshnessSeconds", "label": "KOSIS 유효 기간", "type": "number", "default": "3888000", "unit": "seconds"},
                    {"key": "krxOpenApiKey", "label": "KRX OpenAPI 인증키", "type": "secret", "masked": True},
                    {"key": "externalKrxEnabled", "label": "KRX 공식 시장지수 수집", "type": "toggle", "default": "1"},
                    {"key": "externalKrxTimeoutSeconds", "label": "KRX 요청 시간 제한", "type": "number", "default": "12", "unit": "seconds"},
                    {"key": "externalDataKrxCadenceSeconds", "label": "KRX 확인 주기", "type": "number", "default": "21600", "unit": "seconds"},
                    {"key": "externalDataKrxFreshnessSeconds", "label": "KRX 유효 기간", "type": "number", "default": "259200", "unit": "seconds"},
                    ...
                    {"key": "publicDataPortalServiceKey", "label": "공공데이터포털 서비스키", "type": "secret", "masked": True},
                    {"key": "externalPublicDataStockEnabled", "label": "공식 국내 일별 시세 수집", "type": "toggle", "default": "1"},
                    {"key": "externalPublicDataTimeoutSeconds", "label": "공공데이터포털 요청 제한", "type": "number", "default": "12", "unit": "seconds"},
                    {"key": "externalDataPublicStockCadenceSeconds", "label": "공식 일별 시세 확인 주기", "type": "number", "default": "21600", "unit": "seconds"},
                    {"key": "externalDataPublicStockFreshnessSeconds", "label": "공식 일별 시세 유효 기간", "type": "number", "default": "259200", "unit": "seconds"},
                    {"key": "externalDataPublicStockMaxPartitions", "label": "공식 일별 시세 최대 종목", "type": "number", "default": "100"},
                    ...
                    {"key": "externalDartDocumentMaxPerSymbol", "label": "종목별 중요 공시 원문 수", "type": "number", "default": "3"},
                    ...
                    {"key": "externalSignalCacheMaxAgeMinutes", "label": "외부 신호 캐시 TTL", "type": "number", "default": "30", "unit": "minutes"},
                    {"key": "dataFreshnessEnabled", "label": "알림 데이터 신선도 게이트", "type": "toggle", "default": "1"},
                    {"key": "newsDigestFreshnessGateEnabled", "label": "뉴스 알림 신선도 강제", "type": "toggle", "default": "1"},
                    {"key": "dataFreshnessNewsDigestMaxAgeMinutes", "label": "뉴스 알림 최대 경과(분)", "type": "number", "default": "240", "min": 15, "max": 4320, "step": 15},
                    ...
                    {"key": "kisInvestorIntradayEstimateEnabled", "label": "KIS 장중 외국인·기관 추정 수급", "type": "toggle", "default": "1"},
                    ...
                    {"key": "dataFreshnessExternalCryptoMaxAgeMinutes", "label": "크립토 신호 신선도", "type": "number", "default": "25", "unit": "minutes"},
                    ...
                    {"key": "marketObservationRawDeliveryMode", "label": "시세 원시 알림 발송 방식", "type": "select", "options": ["critical-only", "typedb-first", "always", "disabled"], "default": "critical-only"},
                    {"key": "marketObservationImmediatePriceChangePct", "label": "시세 원시 즉시 알림 기준", "type": "number", "default": "3", "unit": "%"},
                    {"key": "marketObservationImmediateCadenceMinutes", "label": "시세 원시 즉시 알림 보호 주기", "type": "number", "default": "10", "unit": "minutes"},
                    {"key": "monitorAccountIntervalSeconds", "label": "계좌 시세 확인 주기", "type": "number", "default": "120", "unit": "seconds"},
                    {"key": "externalFredSeries", "label": "FRED 지표", "type": "text"},
                    {"key": "externalCryptoIds", "label": "CoinGecko 코인 ID", "type": "text"},
                    {"key": "externalCoinGeckoFetchIntervalMinutes", "label": "CoinGecko 수집 주기", "type": "number", "default": "10", "unit": "minutes"},
                    ...
                    {"key": "externalSecDocumentMaxPerSymbol", "label": "종목별 SEC 원문 수", "type": "number", "default": "3"},
                    ...
                    {"key": "notificationAiReasoningEffort", "label": "투자 판단 추론 강도 고정", "type": "select", "options": ["auto", "low", "medium", "high", "max"], "default": "auto"},
                    {"key": "notificationAiStandardReasoningEffort", "label": "일반 투자 판단 추론 강도", "type": "select", "options": ["low", "medium", "high", "max"], "default": "medium"},
                    ...
                    {"key": "notificationAiCostControlEnabled", "label": "AI 반복 분석 비용 제한", "type": "toggle", "default": "1"},
                    {"key": "notificationAiSubjectCooldownMinutes", "label": "종목별 AI 재분석 대기", "type": "number", "default": "180", "unit": "minutes"},
                    {"key": "notificationAiSubjectDailyLimit", "label": "종목별 하루 AI 분석 상한", "type": "number", "default": "6"},
                    {"key": "notificationAiDailyLimit", "label": "하루 투자 AI 분석 상한", "type": "number", "default": "40"},
                    {"key": "notificationAiMaxEffortDailyLimit", "label": "하루 max 추론 상한", "type": "number", "default": "8"},
                    {"key": "securityLineMappings", "label": "ADR·레버리지 증권 관계", "type": "assignmentText"},
                    {"key": "newsCollectionEnabled", "label": "뉴스 아카이브 실시간 수집", "type": "toggle", "default": "1"},
                    {"key": "newsCollectionIntervalSeconds", "label": "뉴스 수집 주기", "type": "number", "default": "120", "unit": "seconds"},
                    {"key": "newsCollectionRunBudgetSeconds", "label": "뉴스 수집 실행 시간 상한", "type": "number", "default": "45", "unit": "seconds"},
                    {"key": "newsCollectionMaxSymbols", "label": "한 주기에 수집할 뉴스 종목 수", "type": "number", "default": "6"},
                    ...
                    {"key": "newsCollectionProviders", "label": "해외 뉴스 수집 채널(호환)", "type": "text", "default": "google_rss_us,yahoo_search,yahoo_finance,gdelt"},
                    {"key": "newsCollectionInternationalProviders", "label": "해외 뉴스 수집 채널", "type": "text", "default": "google_rss_us,yahoo_search,yahoo_finance,gdelt"},
                    {"key": "newsCollectionKoreanProviders", "label": "국내 종목 우선 뉴스 채널", "type": "text", "default": "google_rss_kr,yahoo_search,yahoo_finance,gdelt"},
                    {"key": "newsCollectionBoundedParallelEnabled", "label": "뉴스 공급자 제한 병렬 수집", "type": "toggle", "default": "1"},
                    {"key": "newsCollectionProviderParallelism", "label": "동시 뉴스 공급자 수", "type": "number", "default": "2"},
                    {"key": "newsCollectionPrimaryProviderCount", "label": "우선 호출 공급자 수", "type": "number", "default": "2"},
                    {"key": "newsCollectionPrimaryMinimumItems", "label": "대체 공급자 생략 최소 기사 수", "type": "number", "default": "2"},
                    {"key": "newsCollectionGoogleKrEnabled", "label": "Google News KR 사용", "type": "toggle", "default": "1"},
                    {"key": "newsCollectionGoogleUsEnabled", "label": "Google News US 사용", "type": "toggle", "default": "1"},
                    {"key": "newsCollectionYahooSearchEnabled", "label": "Yahoo Finance 검색 사용", "type": "toggle", "default": "1"},
                    {"key": "newsCollectionYahooRssEnabled", "label": "Yahoo Finance RSS 사용", "type": "toggle", "default": "1"},
                    {"key": "newsCollectionGdeltSyncEnabled", "label": "GDELT 뉴스 사용", "type": "toggle", "default": "1"},
                    {"key": "newsCollectionGdeltRateLimitSeconds", "label": "GDELT 최소 요청 간격 (6초 이상)", "type": "number", "default": "6", "unit": "seconds"},
                    {"key": "newsCollectionGdeltTimeoutSeconds", "label": "GDELT 요청 타임아웃", "type": "number", "default": "6", "unit": "seconds"},
                    {"key": "newsCollectionGdeltDailyRequestBudget", "label": "GDELT 하루 요청 예산", "type": "number", "default": "240"},
                    {"key": "informationFollowupEnabled", "label": "뉴스·공시·발표 결과 후속 관찰", "type": "toggle", "default": "1"},
                    ...
                    {"key": "newsCollectionArticleBodyCacheMinutes", "label": "성공 원문 캐시 보존", "type": "number", "default": "180", "unit": "minutes"},
                    {"key": "newsCollectionArticleBodyFailureCacheMinutes", "label": "원문 실패 캐시 보존", "type": "number", "default": "5", "unit": "minutes"},
                    {"key": "newsCollectionArticleBodyCacheMaxEntries", "label": "원문 메모리 캐시 상한", "type": "number", "default": "512"},
                    {"key": "newsCollectionQualityGateEnabled", "label": "뉴스 저장 품질 게이트", "type": "toggle", "default": "1"},
                    {"key": "newsCollectionMinimumRelevanceState", "label": "뉴스 수집 최소 관련성", "type": "text", "default": "direct"},
                    {"key": "newsCollectionMinimumMaterialityState", "label": "뉴스 저장 최소 중요 상태", "type": "select", "options": ["notable", "material"], "default": "material"},
                    {"key": "newsCollectionMinimumSourceTrustState", "label": "뉴스 저장 최소 출처 상태", "type": "select", "options": ["standard", "trusted"], "default": "standard"},
                    {"key": "newsCollectionRequireArticleBody", "label": "뉴스 저장 시 원문 본문 필수", "type": "toggle", "default": "1"},
                    ...
                    {"key": "newsDigestRequireKoreanTitleTranslation", "label": "영문 기사 한국어 제목 완료 후 알림", "type": "toggle", "default": "1"},
                    ...
                    {"key": "newsEvidenceMaxAgeMinutes", "label": "뉴스 근거 보존 기간", "type": "number", "default": "4320", "unit": "minutes"},
                    ...
                    {"key": "newsAiAnalysisUseCodex", "label": "기사 분석 GPT-5.6 Sol 사용", "type": "toggle", "default": "1"},
                    {"key": "newsAiAnalysisReasoningEffort", "label": "기사 분석 추론 강도", "type": "select", "options": ["low", "medium", "high", "max"], "default": "medium"},
                    {"key": "newsAiAnalysisCommand", "label": "기사 분석 외부 명령 (고정 모델 정책에서 사용 안 함)", "type": "text"},
                    {"key": "newsAiAnalysisTimeoutSeconds", "label": "기사 분석 타임아웃", "type": "number", "default": "90", "unit": "seconds"},
                    {"key": "newsAiAnalysisInlineTimeoutSeconds", "label": "수집 중 기사 AI 시간 상한", "type": "number", "default": "8", "unit": "seconds"},
                    {"key": "newsAiAnalysisInlineEnabled", "label": "수집 중 기사 AI 분석", "type": "toggle", "default": "0"},
                    {"key": "newsAiAnalysisAsyncEnabled", "label": "비동기 기사 요약·번역 워커", "type": "toggle", "default": "1"},
                    {"key": "newsAiAnalysisWorkerIntervalSeconds", "label": "기사 요약·번역 워커 주기", "type": "number", "default": "60", "unit": "seconds"},
                    {"key": "newsAiAnalysisWorkerBatchSize", "label": "기사 요약·번역 워커 배치", "type": "number", "default": "1"},
                    {"key": "newsAiAnalysisWorkerMaxBatchSize", "label": "기사 요약·번역 적체 시 최대 배치", "type": "number", "default": "2"},
                    {"key": "newsAiAnalysisBacklogScaleThreshold", "label": "기사 요약·번역 배치 확대 대기 건수", "type": "number", "default": "6"},
                    {"key": "newsAiAnalysisWorkerScanLimit", "label": "기사 요약·번역 대기열 조회 상한", "type": "number", "default": "160"},
                    {"key": "newsAiAnalysisRetryMinutes", "label": "기사 요약·번역 재시도 간격", "type": "number", "default": "30", "unit": "minutes"},
                    {"key": "investmentCalendarAiResearchEnabled", "label": "뉴스 기반 일정 후보 분석", "type": "toggle", "default": "1"},
                    {"key": "investmentCalendarAiResearchRunCollection", "label": "후보 분석 전 뉴스 수집", "type": "toggle", "default": "1"},
                    {"key": "investmentCalendarAiResearchEvidenceLimit", "label": "후보 분석 근거 상한", "type": "number", "default": "120"},
                    {"key": "investmentCalendarAiResearchCandidateLimit", "label": "후보 분석 저장 상한", "type": "number", "default": "50"},
                    {"key": "investmentCalendarDiscoveryEnabled", "label": "정기 투자 일정 탐색", "type": "toggle", "default": "1"},
                    {"key": "investmentCalendarDiscoveryIntervalHours", "label": "일정 탐색 주기", "type": "number", "default": "12", "unit": "hours"},
                    {"key": "investmentCalendarDiscoveryMaxSymbols", "label": "일정 탐색 종목 수", "type": "number", "default": "12"},
                    {"key": "investmentCalendarDiscoveryHorizonDays", "label": "일정 탐색 범위", "type": "number", "default": "180", "unit": "days"},
                    {"key": "investmentCalendarOfficialMacroSyncEnabled", "label": "공식 거시 일정 동기화", "type": "toggle", "default": "1"},
                    {"key": "externalOfficialReleaseEnabled", "label": "공식 발표 결과 수집 (한국은행·미국 CPI·고용·FOMC)", "type": "toggle", "default": "1"},
                    {"key": "externalOfficialReleaseCadenceSeconds", "label": "공식 발표 결과 확인 주기", "type": "number", "default": "1800", "unit": "seconds"},
                    {"key": "externalBlsStatisticsEnabled", "label": "BLS 공식 통계 조회 (6시간 주기)", "type": "toggle", "default": "1"},
                    {"key": "externalDocumentRecoveryEnabled", "label": "누락 공시 본문 자동 복구", "type": "toggle", "default": "1"},
                    {"key": "externalDocumentRecoveryBatchSize", "label": "15분마다 확인할 누락 공시 수", "type": "number", "default": "25"},
                    {"key": "investmentCalendarOfficialMacroSyncIntervalHours", "label": "공식 일정 동기화 주기", "type": "number", "default": "12", "unit": "hours"},
                    {"key": "investmentCalendarOfficialEarningsSyncEnabled", "label": "OpenDART 공식 실적 일정 동기화", "type": "toggle", "default": "1"},
                    {"key": "investmentCalendarOfficialEarningsLookbackDays", "label": "공식 실적 공시 확인 범위", "type": "number", "default": "180", "unit": "days"},
                    {"key": "investmentCalendarOfficialEarningsMaxSymbols", "label": "공식 실적 일정 대상 종목 수", "type": "number", "default": "20"},
                    {"key": "investmentCalendarBokPolicyDecisionEnabled", "label": "한국은행 금리 결정 일정", "type": "toggle", "default": "1"},
                    {"key": "investmentCalendarBokPolicyDecisionTimeKst", "label": "한국은행 알림 기준 시각", "type": "text", "default": "09:00"},
                    {"key": "investmentCalendarBokPolicyDecisionLookaheadYears", "label": "한국은행 일정 조회 연수", "type": "number", "default": "1"},
                    {"key": "investmentCalendarFedFomcEnabled", "label": "미국 연준 FOMC 일정", "type": "toggle", "default": "1"},
                    {"key": "investmentCalendarFedDecisionTimeEt", "label": "FOMC 알림 기준 시각(ET)", "type": "text", "default": "14:00"},
                    {"key": "investmentCalendarBlsMacroEnabled", "label": "미국 CPI·고용 공식 일정", "type": "toggle", "default": "1"},
                    {"key": "investmentCalendarBlsFredFallbackEnabled", "label": "BLS 차단 시 FRED 일정 사용", "type": "toggle", "default": "1"},
                    {"key": "investmentCalendarBeaMacroEnabled", "label": "미국 GDP·PCE 공식 일정", "type": "toggle", "default": "1"},
                    {"key": "ontologyProjectionGraphCacheEnabled", "label": "동일 입력 메모리 그래프 조립 캐시", "type": "toggle", "default": "1"},
                    {"key": "ontologyProjectionGraphCacheTtlSeconds", "label": "메모리 그래프 조립 캐시 유지", "type": "number", "default": "45", "unit": "seconds"},
                    {"key": "ontologyProjectionGraphCacheMaxEntries", "label": "메모리 그래프 조립 캐시 최대 건수", "type": "number", "default": "16"},
                    {"key": "ontologyProjectionGraphPersistentCacheEnabled", "label": "재시작 간 그래프 조립 캐시", "type": "toggle", "default": "1"},
                    {"key": "ontologyProjectionGraphPersistentCacheTtlSeconds", "label": "재시작 간 그래프 조립 캐시 유지", "type": "number", "default": "120", "unit": "seconds"},
                    {"key": "ontologyProjectionGraphPersistentCacheMaxEntries", "label": "재시작 간 그래프 조립 캐시 최대 건수", "type": "number", "default": "64"},
                    {"key": "ontologyProjectionGraphPersistentCacheMaxPayloadBytes", "label": "재시작 간 그래프 조립 캐시 최대 크기", "type": "number", "default": "8388608", "unit": "bytes"},
                    {"key": "ontologyDecisionEpisodeContextPerSymbolLimit", "label": "종목별 최근 판단 이력", "type": "number", "default": "3"},
                    {"key": "ontologyDecisionEpisodeContextMaxEpisodes", "label": "실시간 추론 판단 이력 상한", "type": "number", "default": "24"},
                    {"key": "ontologyDecisionEpisodeContextHypothesisLimit", "label": "판단 이력당 가설 상한", "type": "number", "default": "3"},
                    {"key": "ontologyDecisionEpisodeContextOutcomeLimit", "label": "판단 이력당 결과 관측 상한", "type": "number", "default": "8"},
                    {"key": "ontologyMonitorInlineProjectionEnabled", "label": "모니터에서 TypeDB 즉시 추론(운영 시 끔)", "type": "toggle", "default": "0"},
                    ...
                    {"key": "ontologyReasoningMaxSymbolsPerRun", "label": "한 세대에 TypeDB 추론할 종목 상한", "type": "number", "default": "1"},
                    {"key": "ontologyReasoningAdaptiveBatchEnabled", "label": "대기열 압력 기반 다종목 배치", "type": "toggle", "default": "0"},
                    {"key": "ontologyReasoningAdaptiveBatchSteadySymbols", "label": "평상시 TypeDB 대상 종목 수", "type": "number", "default": "1"},
                    {"key": "ontologyReasoningAdaptiveBatchBurstSymbols", "label": "대기 지연 시 TypeDB 대상 종목 수", "type": "number", "default": "1"},
                    {"key": "ontologyReasoningAdaptiveBatchPendingThreshold", "label": "다종목 배치 대기 요청 기준", "type": "number", "default": "2"},
                    {"key": "ontologyReasoningAdaptiveBatchAgeSeconds", "label": "다종목 배치 대기 시간 기준", "type": "number", "default": "30", "unit": "seconds"},
                    {"key": "ontologyReasoningAdaptiveBatchRuntimeGuardSeconds", "label": "느린 추론 시 단일 종목 복귀 기준", "type": "number", "default": "300", "unit": "seconds"},
                    {"key": "ontologyReasoningAdaptiveBatchBudgetSeconds", "label": "다종목 추론 실행 예산", "type": "number", "default": "300", "unit": "seconds"},
                    {"key": "ontologyReasoningAdaptiveBatchBacklogBurstEnabled", "label": "오래된 대기열 즉시 다종목 배치", "type": "toggle", "default": "0"},
                    {"key": "ontologyReasoningAdaptiveBatchBacklogBurstAgeSeconds", "label": "대기열 대형 배치 전환 기준", "type": "number", "default": "120", "unit": "seconds"},
                    ...
                    {"key": "ontologyReasoningMailboxRetentionHours", "label": "완료 메일박스 이력 보관", "type": "number", "default": "72", "unit": "hours"},
                    {"key": "ontologyReasoningWorkLeaseSeconds", "label": "추론 작업 lease 보호 시간", "type": "number", "default": "600", "unit": "seconds"},
                    {"key": "ontologyReasoningWorkRetrySeconds", "label": "작업 실패 재시도 최소 대기", "type": "number", "default": "30", "unit": "seconds"},
                    {"key": "ontologyReasoningQueueProbeCacheSeconds", "label": "저우선 워커 큐 상태 캐시", "type": "number", "default": "5", "unit": "seconds"},
                    {"key": "ontologyReasoningSourceFreshnessEnabled", "label": "추론 입력 원천 시각 검증", "type": "toggle", "default": "1"},
                    {"key": "ontologyReasoningRealtimeEventMaxAgeMinutes", "label": "실시간 입력 최대 경과", "type": "number", "default": "15", "unit": "minutes"},
                    {"key": "ontologyReasoningResearchEventMaxAgeMinutes", "label": "리서치 입력 최대 경과", "type": "number", "default": "360", "unit": "minutes"},
                    {"key": "ontologyReasoningTelemetryHistoryLimit", "label": "추론 실행 이력 보관 수", "type": "number", "default": "24"},
                    {"key": "typedbNativeRuleTargetSymbolLimit", "label": "TypeDB 네이티브 추론 대상 종목 상한", "type": "number", "default": "4"},
                    {"key": "typedbNativeRuleTargetParallelism", "label": "TypeDB 대상 종목 읽기 병렬 수", "type": "number", "default": "4"},
                    {"key": "typedbNativeRuleSubjectFanoutEnabled", "label": "TypeDB 종목별 독립 추론", "type": "toggle", "default": "0"},
                    {"key": "typedbNativeRuleSubjectParallelism", "label": "TypeDB 종목 추론 병렬 수", "type": "number", "default": "2"},
                    {"key": "typedbNativeRuleTotalReadParallelism", "label": "TypeDB 전체 규칙 읽기 병렬 상한", "type": "number", "default": "4"},
                    {"key": "typedbNativeRuleAdaptiveTargetShardingEnabled", "label": "느린 TypeDB 규칙 사전 대상 분할", "type": "toggle", "default": "1"},
                    {"key": "typedbNativeRuleAdaptiveTargetShardingLookbackRuns", "label": "느린 규칙 실행 이력 조회 수", "type": "number", "default": "12"},
                    {"key": "typedbNativeRuleAdaptiveTargetShardingParallelism", "label": "느린 규칙 대상 분할 수", "type": "number", "default": "2"},
                    {"key": "typedbNativeRuleSelectionEnabled", "label": "변경 범위 기반 RuleBox 선택", "type": "toggle", "default": "1"},
                    {"key": "typedbIncrementalEquivalenceAuditSamplePct", "label": "증분 추론 전체 규칙 검증 표본", "type": "number", "default": "5", "unit": "%"},
                    {"key": "typedbIncrementalEquivalenceRecoveryFullRuns", "label": "불일치 후 전체 실행 복구 횟수", "type": "number", "default": "3"},
                    {"key": "typedbIncrementalEquivalenceHealthLookback", "label": "증분 동등성 감사 조회 수", "type": "number", "default": "20"},
                    {"key": "typedbIncrementalEquivalenceHealthCacheSeconds", "label": "증분 안전 상태 캐시", "type": "number", "default": "0", "unit": "seconds"},
                    {"key": "typedbNativeRuleParallelism", "label": "TypeDB 규칙 병렬 실행 수", "type": "number", "default": "2"},
                    {"key": "typedbNativeRuleExecutionBudgetSeconds", "label": "TypeDB 네이티브 규칙 전체 실행 예산", "type": "number", "default": "240", "unit": "seconds"},
                    ...
                    {"key": "ontologyReasoningCriticalMinIntervalSeconds", "label": "즉시 확인 추론 최소 간격", "type": "number", "default": "30", "unit": "seconds"},
                    {"key": "ontologyReasoningMarketMinIntervalSeconds", "label": "시세·수급 추론 최소 간격", "type": "number", "default": "180", "unit": "seconds"},
                    {"key": "ontologyReasoningResearchMinIntervalSeconds", "label": "일반 뉴스·리서치 추론 최소 간격", "type": "number", "default": "300", "unit": "seconds"},
                    {"key": "ontologyReasoningObservationFollowupTargetLimit", "label": "시세 후속 확인 동시 종목 상한", "type": "number", "default": "3"},
                    ...
                    {"key": "ontologyReasoningQueueWarningAgeMinutes", "label": "대기 지연 경고 시간", "type": "number", "default": "30", "unit": "minutes"},
                    {"key": "ontologyReasoningQueueCriticalAgeMinutes", "label": "대기 심각 시간", "type": "number", "default": "90", "unit": "minutes"},
                    {"key": "ontologyReasoningQueueWarningPendingCount", "label": "대기 요청 경고 수", "type": "number", "default": "100"},
                    {"key": "ontologyReasoningQueueCriticalPendingCount", "label": "대기 요청 심각 수", "type": "number", "default": "200"},
                    {"key": "ontologyReasoningQueueWarningOverdueSymbols", "label": "대기 한도 초과 종목 경고 수", "type": "number", "default": "3"},
                    {"key": "ontologyReasoningQueueCriticalOverdueSymbols", "label": "대기 한도 초과 종목 심각 수", "type": "number", "default": "8"},
                    {"key": "ontologyReasoningQueueConsecutiveObservations", "label": "지연 연속 확인 횟수", "type": "number", "default": "3"},
                    {"key": "ontologyReasoningQueueNoProgressMinutes", "label": "처리 진행 신호 정체 시간", "type": "number", "default": "15", "unit": "minutes"},
                    {"key": "ontologyReasoningQueueAlertReminderMinutes", "label": "지연 운영 알림 재전송", "type": "number", "default": "60", "unit": "minutes"},
                    {"key": "investmentAlertCoverageEnabled", "label": "중요 사건 알림 누락 감시", "type": "toggle", "default": "1"},
                    {"key": "investmentAlertCoverageReconcileSeconds", "label": "알림 커버리지 점검 주기", "type": "number", "default": "60", "unit": "seconds"},
                    {"key": "investmentAlertCoverageLookbackHours", "label": "알림 커버리지 조회 범위", "type": "number", "default": "24", "unit": "hours"},
                    {"key": "investmentAlertCoverageDeadlineSeconds", "label": "중요 사건 처리 제한시간", "type": "number", "default": "300", "unit": "seconds"},
                    {"key": "investmentAlertCoverageStarvationMinCandidates", "label": "무알림 정책 점검 최소 후보", "type": "number", "default": "8"},
                    {"key": "investmentAlertCoverageConsecutiveObservations", "label": "누락 경고 연속 확인 횟수", "type": "number", "default": "3"},
                    {"key": "investmentAlertCoverageReminderMinutes", "label": "누락 운영 알림 재전송", "type": "number", "default": "360", "unit": "minutes"},
                    {"key": "ontologyReasoningBackpressureEnabled", "label": "추론 런타임 기반 백프레셔", "type": "toggle", "default": "1"},
                    {"key": "ontologyReasoningBackpressureFactor", "label": "백프레셔 런타임 배수", "type": "number", "default": "1.15"},
                    {"key": "ontologyReasoningBackpressureMaxSeconds", "label": "백프레셔 최대 대기", "type": "number", "default": "900", "unit": "seconds"},
                    {"key": "ontologyReasoningProcessIsolationEnabled", "label": "추론 실행 프로세스 격리", "type": "toggle", "default": "1"},
                    {"key": "ontologyReasoningPersistentWorkerEnabled", "label": "추론 영구 격리 워커(연결 재사용)", "type": "toggle", "default": "1"},
                    {"key": "ontologyReasoningExecutionTimeoutSeconds", "label": "추론 실행 시간 상한", "type": "number", "default": "360", "unit": "seconds"},
                    ...
                    {"key": "ontologyReasoningPreNativeTimeoutBackoffSeconds", "label": "TypeDB 저장 전 시간 초과 재시도 대기", "type": "number", "default": "45", "unit": "seconds"},
                    {"key": "ontologyProjectionAuditStaleAfterSeconds", "label": "중단 투영 감사 정리 기준(0=자동)", "type": "number", "default": "0", "unit": "seconds"},
                    {"key": "ontologyScopeIntegrityAuditEnabled", "label": "스코프 무결성 읽기 점검", "type": "toggle", "default": "1"},
                    {"key": "ontologyScopeIntegrityAuditIntervalMinutes", "label": "스코프 무결성 점검 주기", "type": "number", "default": "30", "unit": "minutes"},
                    {"key": "ontologyScopeIntegrityAuditBatchSize", "label": "점검당 스코프 수", "type": "number", "default": "20"},
                    {"key": "ontologyScopeRepairRetryMinutes", "label": "스코프 자동 복구 재시도", "type": "number", "default": "5", "unit": "minutes"},
                    {"key": "ontologyScopeRepairVerificationMinutes", "label": "스코프 복구 재검증", "type": "number", "default": "5", "unit": "minutes"},
                    {"key": "ontologyAboxMaintenanceEnabled", "label": "ABox 이력 정리", "type": "toggle", "default": "1"},
                    {"key": "ontologyAboxMaintenanceIntervalSeconds", "label": "ABox 정리 점검 주기", "type": "number", "default": "60", "unit": "seconds"},
                    {"key": "ontologyAboxMaintenanceMaxManifestsPerRun", "label": "정리당 매니페스트 상한", "type": "number", "default": "2"},
                    {"key": "ontologyAboxMaintenanceMaxDeleteBatchesPerRun", "label": "정리당 삭제 배치 상한", "type": "number", "default": "2"},
                    {"key": "ontologyAboxMaintenanceDeleteBatchSize", "label": "ABox 삭제 배치 크기", "type": "number", "default": "150"},
                    {"key": "ontologyAboxMaintenanceKeepInactiveManifestCount", "label": "롤백용 비활성 세대 보관", "type": "number", "default": "1"},
                    {"key": "ontologyAboxMaintenanceAdaptiveDrainMaxDeleteBatchesPerRun", "label": "적체 시 삭제 배치 최대", "type": "number", "default": "4"},
                    ...
                    {"key": "ontologyAboxMaintenanceExecutionReserveSeconds", "label": "정리 종료 여유(초)", "type": "number", "default": "30"},
                    {"key": "ontologyAboxMaintenanceSliceSeconds", "label": "ABox 정리 1회 시간 예산", "type": "number", "default": "45", "unit": "seconds"},
                    ...
                    {"key": "ontologyInferenceDetailOutboxEnabled", "label": "InferenceBox 상세 읽기 아웃박스", "type": "toggle", "default": "1"},
                    ...
                    {"key": "ontologyAboxMaintenanceMaxReasoningDeferralSeconds", "label": "ABox 정리 최대 유예", "type": "number", "default": "120", "unit": "seconds"},
                    {"key": "ontologyAboxMaintenanceBusyRetrySeconds", "label": "ABox 정리 유휴 구간 재확인", "type": "number", "default": "10", "unit": "seconds"},
                    {"key": "ontologyAboxMaintenancePriorityInactiveManifestCount", "label": "ABox 적체 우선 선택 기준", "type": "number", "default": "8", "unit": "generations"},
                    {"key": "ontologyAboxMaintenanceYieldEnabled", "label": "ABox 정리를 위해 추론 일시 양보", "type": "toggle", "default": "0"},
                    ...
                    {"key": "marketMaterialityTrendDistanceChangePct", "label": "추세 이격 추가 변화", "type": "number", "default": "1", "unit": "%p"},
                    {"key": "marketMaterialityVolumeRatio", "label": "거래량 중요 배율", "type": "number", "default": "1.5", "unit": "x"},
                    {"key": "marketMaterialityInvestorFlowRatioPct", "label": "외국인·기관 수급 중요 비중", "type": "number", "default": "15", "unit": "%"},
                    {"key": "marketSignalTransitionPolicyEnabled", "label": "시장 신호 상태 전이 정책", "type": "toggle", "default": "1"},
                    {"key": "marketSignalPersistenceObservations", "label": "신호 확정 반복 관측 수", "type": "number", "default": "2", "unit": "observations"},
                    {"key": "marketSignalPricePersistenceObservations", "label": "가격 변화 확정 반복 관측 수", "type": "number", "default": "2", "unit": "observations"},
                    {"key": "marketSignalPriceResetPct", "label": "누적 가격 기준선 복귀 폭", "type": "number", "default": "0.25", "unit": "%"},
                    {"key": "marketSignalPriceImmediatePct", "label": "가격 급변 즉시 추론 기준", "type": "number", "default": "3", "unit": "%"},
                    {"key": "marketSignalOrderbookEnterPct", "label": "호가 불균형 진입 기준", "type": "number", "default": "25", "unit": "%"},
                    {"key": "marketSignalOrderbookExitPct", "label": "호가 불균형 해제 기준", "type": "number", "default": "15", "unit": "%"},
                    {"key": "marketSignalTradeStrengthBand", "label": "체결강도 방향 진입 폭", "type": "number", "default": "10", "unit": "index"},
                    {"key": "marketSignalTradeStrengthExitBand", "label": "체결강도 방향 해제 폭", "type": "number", "default": "2", "unit": "index"},
                    {"key": "marketSignalVolumeEnterRatio", "label": "거래량 확인 진입 배율", "type": "number", "default": "1.5", "unit": "x"},
                    {"key": "marketSignalVolumeExitRatio", "label": "거래량 확인 해제 배율", "type": "number", "default": "1.2", "unit": "x"},
                    {"key": "marketSignalInvestorFlowExitPct", "label": "투자자 수급 압력 해제 비중", "type": "number", "default": "10", "unit": "%"},
                    {"key": "marketSignalTrendCrossBufferPct", "label": "이동평균 교차 확정 완충 폭", "type": "number", "default": "0.3", "unit": "%"},
                    {"key": "marketSignalTrendCrossExitPct", "label": "이동평균 교차 중립 복귀 폭", "type": "number", "default": "0.1", "unit": "%"},
                    {"key": "marketSignalTrendDistanceExitPct", "label": "이동평균 이격 해제 폭", "type": "number", "default": "1.5", "unit": "%"},
                    {"key": "marketSignalDataStatePersistenceObservations", "label": "데이터 상태 확정 반복 관측 수", "type": "number", "default": "2", "unit": "observations"},
                    {"key": "dartDisclosureAiAnalysisEnabled", "label": "공시 AI 해석 사용", "type": "toggle", "default": "1"},
                    {"key": "dartDisclosureAiUseCodex", "label": "공시 해석 GPT-5.6 Sol 사용", "type": "toggle", "default": "1"},
                    {"key": "dartDisclosureAiReasoningEffort", "label": "공시 해석 추론 강도", "type": "select", "options": ["low", "medium", "high", "max"], "default": "medium"},
                    {"key": "dartDisclosureAiCommand", "label": "공시 해석 외부 명령 (고정 모델 정책에서 사용 안 함)", "type": "text"},
                    ...
                    {"key": "ontologySharedMarketWorldAsyncProjectionEnabled", "label": "공유 시장 비동기 갱신", "type": "toggle", "default": "1"},
                    ...
                    {"key": "typedbAllowDefaultPassword", "label": "로컬 TypeDB 기본 비밀번호 허용", "type": "toggle", "default": "0"},
                    ...
                    {"key": "typedbProjectionCoordinatorRetrySeconds", "label": "TypeDB 전역 투영 재시도", "type": "number", "default": "10", "unit": "seconds"},
                    {"key": "typedbStaticNodeBatchSize", "label": "TypeDB 정적 온톨로지 노드 배치", "type": "number", "default": "1"},
                    {"key": "typedbStaticWriteTransactionQueryCount", "label": "TypeDB 정적 온톨로지 트랜잭션 질의 수", "type": "number", "default": "16"},
                    ...
                    {"key": "typedbCapacityCriticalPercent", "label": "TypeDB 심각 기준", "type": "number", "default": "90", "unit": "%"},
                    {"key": "typedbCapacityAutoRotateCooldownMinutes", "label": "TypeDB 자동 회전 재시도 간격", "type": "number", "default": "60", "unit": "minutes"},
                    {"key": "typedbCapacityAutoRotateFailureRetrySeconds", "label": "TypeDB 회전 실패 첫 재시도 간격", "type": "number", "default": "300", "unit": "seconds"},
                    {"key": "typedbBlueGreenMinimumHeadroomMb", "label": "블루그린 전환 후 최소 여유", "type": "number", "default": "12288", "unit": "MB"},
                    {"key": "typedbBlueGreenEstimatedCandidateMaxMb", "label": "블루그린 후보 예상 상한", "type": "number", "default": "4096", "unit": "MB"},
                    {"key": "typedbBlueGreenRetiredRetentionMinutes", "label": "블루그린 롤백 세대 보관", "type": "number", "default": "120", "unit": "minutes"},
                    {"key": "typedbAgeResetEnabled", "label": "TypeDB 보관 시간 점검", "type": "toggle", "default": "0"},
                    {"key": "typedbDataRetentionHours", "label": "TypeDB 보관 시간", "type": "number", "default": "72", "unit": "hours"},
                    {"key": "typedbDataMaxSizeMb", "label": "TypeDB 최대 용량", "type": "number", "default": "16384", "unit": "MB"},
                    {"key": "typedbMinimumFreeSpaceMb", "label": "TypeDB 최소 디스크 여유", "type": "number", "default": "4096", "unit": "MB"},
                    {"key": "typedbStartupWaitSeconds", "label": "TypeDB 재시작 준비 대기", "type": "number", "default": "1800", "unit": "seconds"},
                ],
            },
            {
                "id": "monitoring",
            ...
            {
                "id": "external-data-collector",
                "title": "외부 데이터 모듈 수집",
                "summary": "공급자별 어댑터를 독립 주기로 실행하고 현재 사실, 변경 이력, 호출 예산과 상태를 정규화해 저장합니다.",
                "localEndpoints": ["GET /api/external-data/status"],
                "commands": [
                ...
                "storage": [
                    "mysql: external_dataset_state",
                    "mysql: external_fact_current",
                    "mysql: external_fact_revision",
                    "mysql: external_provider_state",
                    "mysql: external_collection_runs",
                ],
                "fields": [
                    {"key": "externalDataPlatformEnabled", "label": "모듈 수집 활성화", "type": "boolean", "default": "1"},
                    {"key": "externalDataWorkerIntervalSeconds", "label": "작업 확인 주기(초)", "type": "number", "default": "15"},
                    {"key": "externalDataWorkerBatchSize", "label": "작업 배치", "type": "number", "default": "6"},
                    {"key": "externalDataWorkerConcurrency", "label": "공급자 병렬 수", "type": "number", "default": "3"},
                    {"key": "externalDataRateLimitInlineWaitSeconds", "label": "짧은 호출간격 대기(초)", "type": "number", "default": "2"},
                    {"key": "externalDataRunRetentionDays", "label": "실행 지표 보존(일)", "type": "number", "default": "30"},
                    {"key": "externalDataRevisionRetentionDays", "label": "변경 이력 보존(일)", "type": "number", "default": "365"},
                ],
            },
            {
                "id": "model-review",
                ...
                "settings": [
                    {"key": "modelReviewUseCodex", "label": "GPT-5.6 Sol · max 리뷰 사용", "default": "1"},
                    {"key": "modelReviewCommand", "label": "외부 리뷰 명령 (고정 모델 정책에서 사용 안 함)", "default": ""},
