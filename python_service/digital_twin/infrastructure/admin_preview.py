        ...
        "pages": [
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {"key": "ontologyRuleboxPrewarmBacklogRecoveryEnabled", "label": "오래된 대기열 함수 준비 우선 복구", "type": "toggle", "default": "1"},
                    ...
                    {"key": "ontologyRuleboxPrewarmExecutionTimeoutSeconds", "label": "RuleBox 함수 준비 1회 시간 상한", "type": "number", "default": "60", "unit": "seconds"},
                    ...
                    {"key": "typedbSchemaFunctionProvisionBatchSize", "label": "TypeDB 함수 배포 배치 규칙 수", "type": "number", "default": "1"},
