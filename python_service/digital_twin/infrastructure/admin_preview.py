        ...
        "pages": [
            ...
            },
            {
                ...
                "fields": [
                    ...
                    {"key": "ontologyReasoningMaxSymbolsPerRun", "label": "한 번에 추론할 종목 수", "type": "number", "default": "20"},
                    ...
                    {"key": "ontologyReasoningAdaptiveBatchBurstSymbols", "label": "대기 지연 시 TypeDB 대상 종목 수", "type": "number", "default": "20"},
                    ...
                    {"key": "ontologyReasoningAdaptiveBatchBudgetSeconds", "label": "다종목 추론 실행 예산", "type": "number", "default": "240", "unit": "seconds"},
                    {"key": "ontologyReasoningAdaptiveBatchBacklogBurstEnabled", "label": "오래된 대기열 즉시 대형 배치", "type": "toggle", "default": "1"},
                    ...
                    {"key": "typedbNativeRuleTargetSymbolLimit", "label": "TypeDB 네이티브 추론 대상 종목 상한", "type": "number", "default": "20"},
                    ...
                    {"key": "ontologyReasoningFairnessDrainMinIntervalSeconds", "label": "우선 처리 최소 보호 대기", "type": "number", "default": "60", "unit": "seconds"},
                    ...
                    {"key": "ontologyRuleboxPrewarmIntervalSeconds", "label": "RuleBox 함수 사전 준비 유휴 점검 주기", "type": "number", "default": "60", "unit": "seconds"},
                    {"key": "ontologyRuleboxPrewarmExecutionTimeoutSeconds", "label": "RuleBox 함수 준비 1회 시간 상한", "type": "number", "default": "45", "unit": "seconds"},
