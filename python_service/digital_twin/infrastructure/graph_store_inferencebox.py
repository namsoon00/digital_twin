...
def inferencebox_entity_payload(row: Dict[str, object]) -> Dict[str, object]:
    ...
    return {
        ...
        "targetRole": str(properties.get("targetRole") or row.get("targetRole") or ""),
        "actionPolicy": str(properties.get("actionPolicy") or row.get("actionPolicy") or ""),
        "allowedActions": list_of_strings(properties.get("allowedActions") or row.get("allowedActions")),
        "blockedActions": list_of_strings(properties.get("blockedActions") or row.get("blockedActions")),
...
def inferencebox_relation_payload(row: Dict[str, object]) -> Dict[str, object]:
    ...
    return {
        ...
        "allowedActions": list_of_strings(properties.get("allowedActions") or row.get("allowedActions")),
        "blockedActions": list_of_strings(properties.get("blockedActions") or row.get("blockedActions")),
        "primaryAction": str(properties.get("primaryAction") or row.get("primaryAction") or ""),
        "primaryActionLabel": str(properties.get("primaryActionLabel") or row.get("primaryActionLabel") or ""),
        "candidateAction": str(properties.get("candidateAction") or row.get("candidateAction") or ""),
        "candidateActionLabel": str(properties.get("candidateActionLabel") or row.get("candidateActionLabel") or ""),
        "blockedActionLabels": list_of_strings(properties.get("blockedActionLabels") or row.get("blockedActionLabels")),
        "strengthenConditions": list_of_strings(properties.get("strengthenConditions") or row.get("strengthenConditions")),
        "weakenConditions": list_of_strings(properties.get("weakenConditions") or row.get("weakenConditions")),
        "nextChecks": list_of_strings(properties.get("nextChecks") or row.get("nextChecks")),
        "notificationCategory": str(properties.get("notificationCategory") or row.get("notificationCategory") or ""),
        "notificationSeverity": str(properties.get("notificationSeverity") or row.get("notificationSeverity") or ""),
        "label": str(properties.get("aiInfluenceLabel") or row.get("aiInfluenceLabel") or ""),
        "aiInfluenceLabel": str(properties.get("aiInfluenceLabel") or row.get("aiInfluenceLabel") or ""),
