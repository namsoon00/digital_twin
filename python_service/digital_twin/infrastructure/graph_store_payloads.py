...
PROMOTED_NUMERIC_ENTITY_FIELDS = [
    ...
    "valuationReferenceOnly",
    "valuationModelCount",
    "valuationConsensusPrice",
    "valuationDisagreementPct",
    "analystTargetPrice",
    "analystTargetMedianPrice",
    "analystTargetLowPrice",
    "analystTargetHighPrice",
    ...
    "smartMoneyNetLatest",
    "smartMoneyNetChange",
    "smartMoneyNetCumulative",
    "smartMoneyNetAmountCumulative",
    "smartMoneyTradingValueRatioPct",
    "smartMoneyPositiveSessionRatio",
    "smartMoneyNegativeSessionRatio",
    "smartMoneyFlowPersistenceRatio",
    "smartMoneyFlowAcceleration",
    "smartMoneyFlowDirection",
    "smartMoneyFlowBasis",
    "smartMoneyObservationCount",
    "smartMoneyDistinctObservationCount",
    "smartMoneyDistinctSessionCount",
    "individualNetLatest",
    "eventCount",
    "riskEventCount",
    "supportEventCount",
...
PROMOTED_TEXT_ENTITY_FIELDS = [
    ...
    "investorFlowMeasurementType",
    "investorFlowIsEstimate",
    "investorFlowSourceAsOf",
    "investorFlowProviderUpdateSlot",
    "investorFlowFreshnessStatus",
    "trendRiskState",
    "trendReviewLevel",
    "trendEvidenceRole",
    "trendDataState",
    ...
    def rows_for_entities(self, graph: PortfolioOntology) -> List[Dict[str, object]]:
        ...
        for item in graph.entities:
            ...
            rows.append({
                ...
                "tenantId": str(properties.get("tenantId") or ""),
                "worldId": str(properties.get("worldId") or ""),
                "worldType": str(properties.get("worldType") or ""),
                ...
                **{
                ...
                "derivationPrimaryAction": str(derivation.get("primary_action") or derivation.get("primaryAction") or ""),
                "derivationPrimaryActionLabel": str(derivation.get("primary_action_label") or derivation.get("primaryActionLabel") or ""),
                "derivationCandidateAction": str(derivation.get("candidate_action") or derivation.get("candidateAction") or ""),
                "derivationCandidateActionLabel": str(derivation.get("candidate_action_label") or derivation.get("candidateActionLabel") or ""),
                "derivationBlockedActionLabels": list_of_strings(derivation.get("blocked_action_labels") or derivation.get("blockedActionLabels")),
                "derivationStrengthenConditions": list_of_strings(derivation.get("strengthen_conditions") or derivation.get("strengthenConditions")),
                "derivationWeakenConditions": list_of_strings(derivation.get("weaken_conditions") or derivation.get("weakenConditions")),
                "derivationNextChecks": list_of_strings(derivation.get("next_checks") or derivation.get("nextChecks")),
                "derivationNotificationCategory": str(derivation.get("notification_category") or derivation.get("notificationCategory") or ""),
                "derivationNotificationSeverity": str(derivation.get("notification_severity") or derivation.get("notificationSeverity") or ""),
        ...
        return [
            {
                ...
                "tenantId": str((item.value or {}).get("tenantId") or ""),
                "worldId": str((item.value or {}).get("worldId") or ""),
                "worldType": str((item.value or {}).get("worldType") or ""),
        ...
        return [
            {
                ...
                "worldId": str((graph.worldview or {}).get("worldId") or ""),
        ...
        return [
            {
                ...
                "tenantId": str((item.legacy_model or {}).get("tenantId") or (graph.worldview or {}).get("tenantId") or ""),
                "worldId": str((item.legacy_model or {}).get("worldId") or (graph.worldview or {}).get("worldId") or ""),
                "worldType": str((item.legacy_model or {}).get("worldType") or (graph.worldview or {}).get("worldType") or ""),
        ...
        return [
            {
                ...
                "tenantId": str(item.get("tenantId") or (graph.worldview or {}).get("tenantId") or ""),
                "worldId": str(item.get("worldId") or (graph.worldview or {}).get("worldId") or ""),
                "worldType": str(item.get("worldType") or (graph.worldview or {}).get("worldType") or ""),
