...
MYSQL_SCHEMA = [
    ...
    CREATE TABLE IF NOT EXISTS notification_inbox_receipts (
        ...
        usefulness VARCHAR(24) NOT NULL DEFAULT '',
        feedback_reason VARCHAR(64) NOT NULL DEFAULT '',
        feedback_at VARCHAR(40) NOT NULL DEFAULT '',
        updated_at VARCHAR(40) NOT NULL,
    ...
    CREATE TABLE IF NOT EXISTS market_time_series_observations (
        ...
        trade_strength DOUBLE NULL,
        bid_ask_imbalance DOUBLE NULL,
    ...
    CREATE TABLE IF NOT EXISTS reasoning_engine_jobs (
        ...
        current_stage VARCHAR(96) NOT NULL DEFAULT '',
        stage_started_at VARCHAR(40) NOT NULL DEFAULT '',
        stage_updated_at VARCHAR(40) NOT NULL DEFAULT '',
        stage_details_json LONGTEXT NULL,
        release_fingerprint VARCHAR(64) NOT NULL DEFAULT '',
        validation_cohort_id VARCHAR(96) NOT NULL DEFAULT '',
