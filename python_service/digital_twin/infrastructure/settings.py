...
def runtime_settings() -> Dict[str, str]:
    ...
    settings = {
        ...
        "ontologyGraphStoreMode": value("ontologyGraphStoreMode", "ONTOLOGY_GRAPH_STORE_MODE", "typedb"),
        "ontologyNeo4jEnabled": value("ontologyNeo4jEnabled", "ONTOLOGY_NEO4J_ENABLED", "0"),
