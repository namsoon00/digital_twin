...
def runtime_settings(fast_operational_read: bool = False) -> Dict[str, str]:
    ...
    settings = {
        ...
        "ontologyReasoningAdaptiveBatchBurstSymbols": value("ontologyReasoningAdaptiveBatchBurstSymbols", "ONTOLOGY_REASONING_ADAPTIVE_BATCH_BURST_SYMBOLS", "3"),
        "ontologyReasoningAdaptiveBatchPendingThreshold": value("ontologyReasoningAdaptiveBatchPendingThreshold", "ONTOLOGY_REASONING_ADAPTIVE_BATCH_PENDING_THRESHOLD", "4"),
        "ontologyReasoningAdaptiveBatchAgeSeconds": value("ontologyReasoningAdaptiveBatchAgeSeconds", "ONTOLOGY_REASONING_ADAPTIVE_BATCH_AGE_SECONDS", "60"),
        "ontologyReasoningAdaptiveBatchRuntimeGuardSeconds": value("ontologyReasoningAdaptiveBatchRuntimeGuardSeconds", "ONTOLOGY_REASONING_ADAPTIVE_BATCH_RUNTIME_GUARD_SECONDS", "180"),
        "ontologyReasoningAdaptiveBatchBudgetSeconds": value("ontologyReasoningAdaptiveBatchBudgetSeconds", "ONTOLOGY_REASONING_ADAPTIVE_BATCH_BUDGET_SECONDS", "150"),
