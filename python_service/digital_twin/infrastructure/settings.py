...
def runtime_settings() -> Dict[str, str]:
    ...
    settings = {
        ...
        "typedbABoxRelationBatchSize": value("typedbABoxRelationBatchSize", "TYPEDB_ABOX_RELATION_BATCH_SIZE", "4"),
        ...
        "typedbInferenceBoxRelationBatchSize": value("typedbInferenceBoxRelationBatchSize", "TYPEDB_INFERENCEBOX_RELATION_BATCH_SIZE", "4"),
