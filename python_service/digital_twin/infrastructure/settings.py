...
def runtime_settings() -> Dict[str, str]:
    ...
    settings = {
        ...
        "aiValuationCurrentPriceAnchorEnabled": value("aiValuationCurrentPriceAnchorEnabled", "AI_VALUATION_CURRENT_PRICE_ANCHOR_ENABLED", "1"),
        ...
        "newsCollectionProviders": value("newsCollectionProviders", "NEWS_COLLECTION_PROVIDERS", "yahoo_finance,google_rss_kr,google_rss_us"),
        ...
        "newsCollectionArticleBodyMaxPerTarget": value("newsCollectionArticleBodyMaxPerTarget", "NEWS_COLLECTION_ARTICLE_BODY_MAX_PER_TARGET", "2"),
        "newsCollectionArticleBodyMaxPerRun": value("newsCollectionArticleBodyMaxPerRun", "NEWS_COLLECTION_ARTICLE_BODY_MAX_PER_RUN", "4"),
