...
def runtime_settings() -> Dict[str, str]:
    ...
    settings = {
        ...
        "ontologyGraphStoreMode": value("ontologyGraphStoreMode", "ONTOLOGY_GRAPH_STORE_MODE", "neo4j"),
        "ontologyNeo4jEnabled": value("ontologyNeo4jEnabled", "ONTOLOGY_NEO4J_ENABLED", "1"),
        "ontologyTypeDbEnabled": value("ontologyTypeDbEnabled", "ONTOLOGY_TYPEDB_ENABLED", "0"),
        ...
        "newsCollectionProviders": value("newsCollectionProviders", "NEWS_COLLECTION_PROVIDERS", "google_rss_kr,google_rss_us,gdelt"),
