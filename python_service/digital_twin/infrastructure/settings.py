...
def runtime_settings(fast_operational_read: bool = False) -> Dict[str, str]:
    ...
    settings = {
        ...
        "ontologyAboxMaintenanceMaxReasoningDeferralSeconds": value("ontologyAboxMaintenanceMaxReasoningDeferralSeconds", "ONTOLOGY_ABOX_MAINTENANCE_MAX_REASONING_DEFERRAL_SECONDS", "300"),
