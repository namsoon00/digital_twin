...
def runtime_settings() -> Dict[str, str]:
    ...
    settings = {
        ...
        "typedbABoxRelationBatchSize": value("typedbABoxRelationBatchSize", "TYPEDB_ABOX_RELATION_BATCH_SIZE", "100"),
        "typedbABoxDeleteBatchSize": value("typedbABoxDeleteBatchSize", "TYPEDB_ABOX_DELETE_BATCH_SIZE", "100"),
        ...
        "typedbInferenceBoxRelationBatchSize": value("typedbInferenceBoxRelationBatchSize", "TYPEDB_INFERENCEBOX_RELATION_BATCH_SIZE", "25"),
