...
TEXT_SETTING_KEYS = [
    ...
    "notificationAiAuditRetentionDays",
    "modelName",
    "modelHypothesis",
    "modelTimingScenario",
    "modelTimingSymbols",
    ...
    "ontologyGraphSingleWriterEnabled",
    ...
    "typedbRuntimeHealthProbeIntervalSeconds",
    "typedbRuntimeHealthFailureThreshold",
    "typedbSeedOnStart",
    ...
    "cloudflareNodeExecutable",
    "cloudflaredExecutable",
    "cloudflareSharePort",
    "cloudflareShareFixedEntryUrl",
    "cloudflareSharePublishTargetEnabled",
    "cloudflareShareRotationMinutes",
    "cloudflareShareHealthCheckSeconds",
    "cloudflareShareRotationGraceSeconds",
    ...
    "timeSeriesRuntimeFailoverEnabled",
    "timeSeriesRuntimeHealthCacheSeconds",
    "timeSeriesProjectionCircuitEnabled",
    "timeSeriesProjectionHealthProbeSeconds",
    "timeSeriesAutoFailoverEnabled",
    "timeSeriesAutoFailoverFailureCount",
    ...
    "reasoningEngineReuseRetiredCandidateStoreEnabled",
    ...
    "investmentLaunchMinimumOutcomeEpisodes",
    "investmentLaunchMinimumComparisonSamples",
    "investmentLaunchMaximumP95Ms",
    "investmentLaunchLatencyWindowHours",
    "investmentLaunchMinimumLatencySamples",
    "investmentLaunchMinimumMessageFeedbackSamples",
    "investmentLaunchMinimumHelpfulPct",
    "investmentMessageQualityWindowDays",
    "investmentMessageQualityProposalThreshold",
    "investmentBrainOutcomeBaselineMaxAgeMinutes",
    "investmentProductSoakTestPassed",
    "investmentProductComplianceReviewed",
    ...
    "newsAiAnalysisWorkerMaxBatchSize",
    "newsAiAnalysisBacklogScaleThreshold",
...
DEFAULT_STRATEGY_SETTINGS = {
    ...
    "notificationAiStandardReasoningEffort": "medium",
    ...
    # Delivery remains asynchronous and unbounded. This watchdog bounds one
    # model process so a hung local execution cannot occupy a worker forever.
    "notificationAiAttemptWatchdogSeconds": "300",
    "notificationAiTypeDbFallbackEnabled": "1",
    "notificationAiFallbackOnFirstFailure": "0",
    "notificationAiComparisonRepairReasoningEffort": "medium",
    ...
    "notificationAiCapacityWaitSeconds": "0",
    ...
    "notificationAiQueueTargetPromptBytes": "32768",
    ...
    "notificationAiAuditRetentionDays": "30",
...
def runtime_settings(fast_operational_read: bool = False) -> Dict[str, str]:
    ...
    settings = {
        ...
        "tossApiMinimumRequestIntervalMilliseconds": value(
            "tossApiMinimumRequestIntervalMilliseconds",
            "TOSS_API_MINIMUM_REQUEST_INTERVAL_MILLISECONDS",
            "300",
        ),
        "tossApiAccountRequestIntervalMilliseconds": value(
            "tossApiAccountRequestIntervalMilliseconds",
            "TOSS_API_ACCOUNT_REQUEST_INTERVAL_MILLISECONDS",
            "1200",
        ),
        "tossApiRateLimitCooldownSeconds": value(
            "tossApiRateLimitCooldownSeconds",
            "TOSS_API_RATE_LIMIT_COOLDOWN_SECONDS",
            "5",
        ),
        ...
        "valuationDriverDcfPilotSymbols": value("valuationDriverDcfPilotSymbols", "VALUATION_DRIVER_DCF_PILOT_SYMBOLS", "NVDA,000660"),
        "valuationDriverDcfEquityRiskPremiumPct": value("valuationDriverDcfEquityRiskPremiumPct", "VALUATION_DRIVER_DCF_EQUITY_RISK_PREMIUM_PCT", "5"),
        "valuationDriverDcfTerminalGrowthPct": value("valuationDriverDcfTerminalGrowthPct", "VALUATION_DRIVER_DCF_TERMINAL_GROWTH_PCT", "2.5"),
        "valuationDriverDcfUsEquityRiskPremiumPct": value("valuationDriverDcfUsEquityRiskPremiumPct", "VALUATION_DRIVER_DCF_US_EQUITY_RISK_PREMIUM_PCT", "5"),
        "valuationDriverDcfKrEquityRiskPremiumPct": value("valuationDriverDcfKrEquityRiskPremiumPct", "VALUATION_DRIVER_DCF_KR_EQUITY_RISK_PREMIUM_PCT", "5"),
        "valuationDriverDcfUsTerminalGrowthPct": value("valuationDriverDcfUsTerminalGrowthPct", "VALUATION_DRIVER_DCF_US_TERMINAL_GROWTH_PCT", "2.5"),
        "valuationDriverDcfKrTerminalGrowthPct": value("valuationDriverDcfKrTerminalGrowthPct", "VALUATION_DRIVER_DCF_KR_TERMINAL_GROWTH_PCT", "2.5"),
        ...
        "notificationAiAttemptWatchdogSeconds": value("notificationAiAttemptWatchdogSeconds", "NOTIFICATION_AI_ATTEMPT_WATCHDOG_SECONDS", DEFAULT_STRATEGY_SETTINGS["notificationAiAttemptWatchdogSeconds"]),
        ...
        "localAiInvestmentReservedProcesses": value("localAiInvestmentReservedProcesses", "LOCAL_AI_INVESTMENT_RESERVED_PROCESSES", DEFAULT_STRATEGY_SETTINGS["localAiInvestmentReservedProcesses"]),
        ...
        "notificationAiCapacityWaitSeconds": value("notificationAiCapacityWaitSeconds", "NOTIFICATION_AI_CAPACITY_WAIT_SECONDS", DEFAULT_STRATEGY_SETTINGS["notificationAiCapacityWaitSeconds"]),
        ...
        "notificationAiQueueTargetPromptBytes": value("notificationAiQueueTargetPromptBytes", "NOTIFICATION_AI_QUEUE_TARGET_PROMPT_BYTES", DEFAULT_STRATEGY_SETTINGS["notificationAiQueueTargetPromptBytes"]),
        ...
        "notificationAiCostControlEnabled": value("notificationAiCostControlEnabled", "NOTIFICATION_AI_COST_CONTROL_ENABLED", DEFAULT_STRATEGY_SETTINGS["notificationAiCostControlEnabled"]),
        "notificationAiSubjectCooldownMinutes": value("notificationAiSubjectCooldownMinutes", "NOTIFICATION_AI_SUBJECT_COOLDOWN_MINUTES", DEFAULT_STRATEGY_SETTINGS["notificationAiSubjectCooldownMinutes"]),
        "notificationAiSubjectDailyLimit": value("notificationAiSubjectDailyLimit", "NOTIFICATION_AI_SUBJECT_DAILY_LIMIT", DEFAULT_STRATEGY_SETTINGS["notificationAiSubjectDailyLimit"]),
        "notificationAiDailyLimit": value("notificationAiDailyLimit", "NOTIFICATION_AI_DAILY_LIMIT", DEFAULT_STRATEGY_SETTINGS["notificationAiDailyLimit"]),
        "notificationAiMaxEffortDailyLimit": value("notificationAiMaxEffortDailyLimit", "NOTIFICATION_AI_MAX_EFFORT_DAILY_LIMIT", DEFAULT_STRATEGY_SETTINGS["notificationAiMaxEffortDailyLimit"]),
        ...
        "notificationAiAuditRetentionDays": value("notificationAiAuditRetentionDays", "NOTIFICATION_AI_AUDIT_RETENTION_DAYS", DEFAULT_STRATEGY_SETTINGS["notificationAiAuditRetentionDays"]),
        ...
        "ontologyReasoningMarketMinIntervalSeconds": value("ontologyReasoningMarketMinIntervalSeconds", "ONTOLOGY_REASONING_MARKET_MIN_INTERVAL_SECONDS", "180"),
        ...
        "investmentAlertCoverageEnabled": value("investmentAlertCoverageEnabled", "INVESTMENT_ALERT_COVERAGE_ENABLED", "1"),
        "investmentAlertCoverageReconcileSeconds": value("investmentAlertCoverageReconcileSeconds", "INVESTMENT_ALERT_COVERAGE_RECONCILE_SECONDS", "60"),
        "investmentAlertCoverageLookbackHours": value("investmentAlertCoverageLookbackHours", "INVESTMENT_ALERT_COVERAGE_LOOKBACK_HOURS", "24"),
        "investmentAlertCoverageDeadlineSeconds": value("investmentAlertCoverageDeadlineSeconds", "INVESTMENT_ALERT_COVERAGE_DEADLINE_SECONDS", "300"),
        "investmentAlertCoverageStarvationMinCandidates": value("investmentAlertCoverageStarvationMinCandidates", "INVESTMENT_ALERT_COVERAGE_STARVATION_MIN_CANDIDATES", "8"),
        "investmentAlertCoverageConsecutiveObservations": value("investmentAlertCoverageConsecutiveObservations", "INVESTMENT_ALERT_COVERAGE_CONSECUTIVE_OBSERVATIONS", "3"),
        "investmentAlertCoverageReminderMinutes": value("investmentAlertCoverageReminderMinutes", "INVESTMENT_ALERT_COVERAGE_REMINDER_MINUTES", "360"),
        ...
        "ontologyGraphSingleWriterEnabled": value(
            "ontologyGraphSingleWriterEnabled",
        ...
        "ontologyTemporalObservationAnchorProjectionEnabled": value(
            "ontologyTemporalObservationAnchorProjectionEnabled",
            "ONTOLOGY_TEMPORAL_OBSERVATION_ANCHOR_PROJECTION_ENABLED",
            "auto",
        ),
        ...
        "ontologyRuleCandidateAiTimeoutSeconds": value("ontologyRuleCandidateAiTimeoutSeconds", "ONTOLOGY_RULE_CANDIDATE_AI_TIMEOUT_SECONDS", "0"),
        ...
        "marketSignalTransitionPolicyEnabled": value("marketSignalTransitionPolicyEnabled", "MARKET_SIGNAL_TRANSITION_POLICY_ENABLED", "1"),
        "marketSignalPersistenceObservations": value("marketSignalPersistenceObservations", "MARKET_SIGNAL_PERSISTENCE_OBSERVATIONS", "2"),
        "marketSignalPricePersistenceObservations": value("marketSignalPricePersistenceObservations", "MARKET_SIGNAL_PRICE_PERSISTENCE_OBSERVATIONS", "2"),
        "marketSignalPriceResetPct": value("marketSignalPriceResetPct", "MARKET_SIGNAL_PRICE_RESET_PCT", "0.25"),
        "marketSignalPriceImmediatePct": value("marketSignalPriceImmediatePct", "MARKET_SIGNAL_PRICE_IMMEDIATE_PCT", "3"),
        "marketSignalOrderbookEnterPct": value("marketSignalOrderbookEnterPct", "MARKET_SIGNAL_ORDERBOOK_ENTER_PCT", "25"),
        "marketSignalOrderbookExitPct": value("marketSignalOrderbookExitPct", "MARKET_SIGNAL_ORDERBOOK_EXIT_PCT", "15"),
        "marketSignalTradeStrengthBand": value("marketSignalTradeStrengthBand", "MARKET_SIGNAL_TRADE_STRENGTH_BAND", "10"),
        "marketSignalTradeStrengthExitBand": value("marketSignalTradeStrengthExitBand", "MARKET_SIGNAL_TRADE_STRENGTH_EXIT_BAND", "2"),
        "marketSignalVolumeEnterRatio": value("marketSignalVolumeEnterRatio", "MARKET_SIGNAL_VOLUME_ENTER_RATIO", "1.5"),
        "marketSignalVolumeExitRatio": value("marketSignalVolumeExitRatio", "MARKET_SIGNAL_VOLUME_EXIT_RATIO", "1.2"),
        "marketSignalInvestorFlowExitPct": value("marketSignalInvestorFlowExitPct", "MARKET_SIGNAL_INVESTOR_FLOW_EXIT_PCT", "10"),
        "marketSignalTrendCrossBufferPct": value("marketSignalTrendCrossBufferPct", "MARKET_SIGNAL_TREND_CROSS_BUFFER_PCT", "0.3"),
        "marketSignalTrendCrossExitPct": value("marketSignalTrendCrossExitPct", "MARKET_SIGNAL_TREND_CROSS_EXIT_PCT", "0.1"),
        "marketSignalTrendDistanceExitPct": value("marketSignalTrendDistanceExitPct", "MARKET_SIGNAL_TREND_DISTANCE_EXIT_PCT", "1.5"),
        "marketSignalDataStatePersistenceObservations": value("marketSignalDataStatePersistenceObservations", "MARKET_SIGNAL_DATA_STATE_PERSISTENCE_OBSERVATIONS", "2"),
        ...
        "typedbRuntimeHealthProbeIntervalSeconds": value(
            "typedbRuntimeHealthProbeIntervalSeconds",
            "TYPEDB_RUNTIME_HEALTH_PROBE_INTERVAL_SECONDS",
            "30",
        ),
        "typedbRuntimeHealthFailureThreshold": value(
            "typedbRuntimeHealthFailureThreshold",
        ...
        "dartDisclosureAiReasoningEffort": value("dartDisclosureAiReasoningEffort", "DART_DISCLOSURE_AI_REASONING_EFFORT", "medium"),
        ...
        "timeSeriesRuntimeFailoverEnabled": value("timeSeriesRuntimeFailoverEnabled", "TIME_SERIES_RUNTIME_FAILOVER_ENABLED", "1"),
        "timeSeriesRuntimeHealthCacheSeconds": value("timeSeriesRuntimeHealthCacheSeconds", "TIME_SERIES_RUNTIME_HEALTH_CACHE_SECONDS", "15"),
        "timeSeriesProjectionCircuitEnabled": value("timeSeriesProjectionCircuitEnabled", "TIME_SERIES_PROJECTION_CIRCUIT_ENABLED", "1"),
        "timeSeriesProjectionHealthProbeSeconds": value("timeSeriesProjectionHealthProbeSeconds", "TIME_SERIES_PROJECTION_HEALTH_PROBE_SECONDS", "30"),
        "timeSeriesAutoFailoverEnabled": value("timeSeriesAutoFailoverEnabled", "TIME_SERIES_AUTO_FAILOVER_ENABLED", "1"),
        "timeSeriesAutoFailoverFailureCount": value("timeSeriesAutoFailoverFailureCount", "TIME_SERIES_AUTO_FAILOVER_FAILURE_COUNT", "2"),
        ...
        "reasoningEngineV2StaleObservationMaxAgeSeconds": value(
            "reasoningEngineV2StaleObservationMaxAgeSeconds",
        ...
        "reasoningEngineWorkerHeartbeatCriticalSeconds": value(
            "reasoningEngineWorkerHeartbeatCriticalSeconds",
            "REASONING_ENGINE_WORKER_HEARTBEAT_CRITICAL_SECONDS",
            "90",
        ),
        ...
        "reasoningEngineSharedPremiseInlineRetryMaxSeconds": value(
            "reasoningEngineSharedPremiseInlineRetryMaxSeconds",
            "REASONING_ENGINE_SHARED_PREMISE_INLINE_RETRY_MAX_SECONDS",
            "2",
        ),
        ...
        "operationalActiveFailureWindowMinutes": value(
            "operationalActiveFailureWindowMinutes",
            "OPERATIONAL_ACTIVE_FAILURE_WINDOW_MINUTES",
            "60",
        ),
        "ontologyStoreLogicalShardCount": value(
            "ontologyStoreLogicalShardCount",
            "ONTOLOGY_STORE_LOGICAL_SHARD_COUNT",
            "1",
        ),
        ...
        "investmentReasoningCaseStaleMinutes": value("investmentReasoningCaseStaleMinutes", "INVESTMENT_REASONING_CASE_STALE_MINUTES", "180"),
        "investmentReasoningCaseExpiryIntervalSeconds": value("investmentReasoningCaseExpiryIntervalSeconds", "INVESTMENT_REASONING_CASE_EXPIRY_INTERVAL_SECONDS", "60"),
        "investmentReasoningCaseExpiryBatchSize": value("investmentReasoningCaseExpiryBatchSize", "INVESTMENT_REASONING_CASE_EXPIRY_BATCH_SIZE", "100"),
        ...
        "reasoningEngineReuseRetiredCandidateStoreEnabled": value(
            "reasoningEngineReuseRetiredCandidateStoreEnabled",
        ...
        "reasoningEnginePromotionMaximumCandidateP95Ms": value("reasoningEnginePromotionMaximumCandidateP95Ms", "REASONING_ENGINE_PROMOTION_MAXIMUM_CANDIDATE_P95_MS", "180000"),
        ...
        "reasoningEnginePromotionMaximumEndToEndP95Ms": value("reasoningEnginePromotionMaximumEndToEndP95Ms", "REASONING_ENGINE_PROMOTION_MAXIMUM_END_TO_END_P95_MS", "240000"),
        ...
        "investmentLaunchMinimumOutcomeEpisodes": value("investmentLaunchMinimumOutcomeEpisodes", "INVESTMENT_LAUNCH_MINIMUM_OUTCOME_EPISODES", "50"),
        "investmentLaunchMinimumComparisonSamples": value("investmentLaunchMinimumComparisonSamples", "INVESTMENT_LAUNCH_MINIMUM_COMPARISON_SAMPLES", "20"),
        "investmentLaunchMaximumP95Ms": value("investmentLaunchMaximumP95Ms", "INVESTMENT_LAUNCH_MAXIMUM_P95_MS", "60000"),
        "investmentLaunchLatencyWindowHours": value("investmentLaunchLatencyWindowHours", "INVESTMENT_LAUNCH_LATENCY_WINDOW_HOURS", "6"),
        "investmentLaunchMinimumLatencySamples": value("investmentLaunchMinimumLatencySamples", "INVESTMENT_LAUNCH_MINIMUM_LATENCY_SAMPLES", "20"),
        "investmentLaunchMinimumMessageFeedbackSamples": value("investmentLaunchMinimumMessageFeedbackSamples", "INVESTMENT_LAUNCH_MINIMUM_MESSAGE_FEEDBACK_SAMPLES", "10"),
        "investmentLaunchMinimumHelpfulPct": value("investmentLaunchMinimumHelpfulPct", "INVESTMENT_LAUNCH_MINIMUM_HELPFUL_PCT", "70"),
        "investmentMessageQualityWindowDays": value("investmentMessageQualityWindowDays", "INVESTMENT_MESSAGE_QUALITY_WINDOW_DAYS", "90"),
        "investmentMessageQualityProposalThreshold": value("investmentMessageQualityProposalThreshold", "INVESTMENT_MESSAGE_QUALITY_PROPOSAL_THRESHOLD", "3"),
        "investmentBrainOutcomeBaselineMaxAgeMinutes": value("investmentBrainOutcomeBaselineMaxAgeMinutes", "INVESTMENT_BRAIN_OUTCOME_BASELINE_MAX_AGE_MINUTES", "10080"),
        "investmentProductSoakTestPassed": value("investmentProductSoakTestPassed", "INVESTMENT_PRODUCT_SOAK_TEST_PASSED", "0"),
        "investmentProductComplianceReviewed": value("investmentProductComplianceReviewed", "INVESTMENT_PRODUCT_COMPLIANCE_REVIEWED", "0"),
        ...
        "newsDigestFreshnessGateEnabled": value(
            "newsDigestFreshnessGateEnabled",
            "NEWS_DIGEST_FRESHNESS_GATE_ENABLED",
            "1",
        ),
        ...
        "externalDataEcosCadenceSeconds": value("externalDataEcosCadenceSeconds", "EXTERNAL_DATA_ECOS_CADENCE_SECONDS", "21600"),
        "externalDataEcosFreshnessSeconds": value("externalDataEcosFreshnessSeconds", "EXTERNAL_DATA_ECOS_FRESHNESS_SECONDS", "172800"),
        "externalDataKosisCadenceSeconds": value("externalDataKosisCadenceSeconds", "EXTERNAL_DATA_KOSIS_CADENCE_SECONDS", "21600"),
        "externalDataKosisFreshnessSeconds": value("externalDataKosisFreshnessSeconds", "EXTERNAL_DATA_KOSIS_FRESHNESS_SECONDS", "3888000"),
        "externalDataKrxCadenceSeconds": value("externalDataKrxCadenceSeconds", "EXTERNAL_DATA_KRX_CADENCE_SECONDS", "21600"),
        "externalDataKrxFreshnessSeconds": value("externalDataKrxFreshnessSeconds", "EXTERNAL_DATA_KRX_FRESHNESS_SECONDS", "259200"),
        "externalOfficialReleaseEnabled": value("externalOfficialReleaseEnabled", "EXTERNAL_OFFICIAL_RELEASE_ENABLED", "1"),
        "externalOfficialReleaseCadenceSeconds": value("externalOfficialReleaseCadenceSeconds", "EXTERNAL_OFFICIAL_RELEASE_CADENCE_SECONDS", "1800"),
        "externalBlsStatisticsEnabled": value("externalBlsStatisticsEnabled", "EXTERNAL_BLS_STATISTICS_ENABLED", "1"),
        "informationFollowupEnabled": value("informationFollowupEnabled", "INFORMATION_FOLLOWUP_ENABLED", "1"),
        "newsCollectionGdeltRateLimitSeconds": value("newsCollectionGdeltRateLimitSeconds", "NEWS_COLLECTION_GDELT_RATE_LIMIT_SECONDS", "6"),
        "newsCollectionGdeltDailyRequestBudget": value("newsCollectionGdeltDailyRequestBudget", "NEWS_COLLECTION_GDELT_DAILY_REQUEST_BUDGET", "240"),
        "externalDocumentRecoveryEnabled": value("externalDocumentRecoveryEnabled", "EXTERNAL_DOCUMENT_RECOVERY_ENABLED", "1"),
        "externalDocumentRecoveryBatchSize": value("externalDocumentRecoveryBatchSize", "EXTERNAL_DOCUMENT_RECOVERY_BATCH_SIZE", "25"),
        ...
        "externalDataPublicStockCadenceSeconds": value("externalDataPublicStockCadenceSeconds", "EXTERNAL_DATA_PUBLIC_STOCK_CADENCE_SECONDS", "21600"),
        "externalDataPublicStockFreshnessSeconds": value("externalDataPublicStockFreshnessSeconds", "EXTERNAL_DATA_PUBLIC_STOCK_FRESHNESS_SECONDS", "259200"),
        "externalDataPublicStockMaxPartitions": value("externalDataPublicStockMaxPartitions", "EXTERNAL_DATA_PUBLIC_STOCK_MAX_PARTITIONS", "100"),
        "externalDataPublicReferenceCadenceSeconds": value("externalDataPublicReferenceCadenceSeconds", "EXTERNAL_DATA_PUBLIC_REFERENCE_CADENCE_SECONDS", "21600"),
        "externalDataPublicReferenceFreshnessSeconds": value("externalDataPublicReferenceFreshnessSeconds", "EXTERNAL_DATA_PUBLIC_REFERENCE_FRESHNESS_SECONDS", "604800"),
        "externalDataPublicReferenceMaxPartitions": value("externalDataPublicReferenceMaxPartitions", "EXTERNAL_DATA_PUBLIC_REFERENCE_MAX_PARTITIONS", "100"),
        ...
        "cloudflareNodeExecutable": value(
            "cloudflareNodeExecutable",
            "CLOUDFLARE_NODE_EXECUTABLE",
            "",
        ),
        "cloudflaredExecutable": value(
            "cloudflaredExecutable",
        ...
        "cloudflareShareRotationMinutes": value(
            "cloudflareShareRotationMinutes",
            "SHARE_TUNNEL_ROTATION_MINUTES",
            "360",
        ),
        "cloudflareShareHealthCheckSeconds": value(
            "cloudflareShareHealthCheckSeconds",
            "SHARE_TUNNEL_HEALTH_CHECK_SECONDS",
            "60",
        ),
        "cloudflareShareRotationGraceSeconds": value(
            "cloudflareShareRotationGraceSeconds",
            "SHARE_TUNNEL_ROTATION_GRACE_SECONDS",
            "120",
        ),
        "externalAlphaEnabled": value("externalAlphaEnabled", "EXTERNAL_ALPHA_ENABLED", "1"),
        "externalPublicDataStockEnabled": value("externalPublicDataStockEnabled", "EXTERNAL_PUBLIC_DATA_STOCK_ENABLED", "1"),
        "externalPublicDataReferenceEnabled": value("externalPublicDataReferenceEnabled", "EXTERNAL_PUBLIC_DATA_REFERENCE_ENABLED", "1"),
        "externalPublicDataTimeoutSeconds": value("externalPublicDataTimeoutSeconds", "EXTERNAL_PUBLIC_DATA_TIMEOUT_SECONDS", "12"),
        ...
        "externalEcosEnabled": value("externalEcosEnabled", "EXTERNAL_ECOS_ENABLED", "1"),
        "externalEcosTimeoutSeconds": value("externalEcosTimeoutSeconds", "EXTERNAL_ECOS_TIMEOUT_SECONDS", "10"),
        "externalKosisEnabled": value("externalKosisEnabled", "EXTERNAL_KOSIS_ENABLED", "1"),
        "externalKosisTimeoutSeconds": value("externalKosisTimeoutSeconds", "EXTERNAL_KOSIS_TIMEOUT_SECONDS", "12"),
        "externalKrxEnabled": value("externalKrxEnabled", "EXTERNAL_KRX_ENABLED", "1"),
        "externalKrxTimeoutSeconds": value("externalKrxTimeoutSeconds", "EXTERNAL_KRX_TIMEOUT_SECONDS", "12"),
        ...
        "externalSecDocumentMaxPerSymbol": value("externalSecDocumentMaxPerSymbol", "EXTERNAL_SEC_DOCUMENT_MAX_PER_SYMBOL", "3"),
        ...
        "newsCollectionBoundedParallelEnabled": value("newsCollectionBoundedParallelEnabled", "NEWS_COLLECTION_BOUNDED_PARALLEL_ENABLED", "1"),
        "newsCollectionProviderParallelism": value("newsCollectionProviderParallelism", "NEWS_COLLECTION_PROVIDER_PARALLELISM", "2"),
        "newsCollectionPrimaryProviderCount": value("newsCollectionPrimaryProviderCount", "NEWS_COLLECTION_PRIMARY_PROVIDER_COUNT", "2"),
        "newsCollectionPrimaryMinimumItems": value("newsCollectionPrimaryMinimumItems", "NEWS_COLLECTION_PRIMARY_MINIMUM_ITEMS", "2"),
        "newsCollectionGdeltTimeoutSeconds": value("newsCollectionGdeltTimeoutSeconds", "NEWS_COLLECTION_GDELT_TIMEOUT_SECONDS", "6"),
        ...
        "newsCollectionArticleBodyCacheMinutes": value("newsCollectionArticleBodyCacheMinutes", "NEWS_COLLECTION_ARTICLE_BODY_CACHE_MINUTES", "180"),
        "newsCollectionArticleBodyFailureCacheMinutes": value("newsCollectionArticleBodyFailureCacheMinutes", "NEWS_COLLECTION_ARTICLE_BODY_FAILURE_CACHE_MINUTES", "5"),
        "newsCollectionArticleBodyCacheMaxEntries": value("newsCollectionArticleBodyCacheMaxEntries", "NEWS_COLLECTION_ARTICLE_BODY_CACHE_MAX_ENTRIES", "512"),
        ...
        "newsAiAnalysisReasoningEffort": value("newsAiAnalysisReasoningEffort", "NEWS_AI_ANALYSIS_REASONING_EFFORT", "medium"),
        ...
        "newsAiAnalysisWorkerMaxBatchSize": value("newsAiAnalysisWorkerMaxBatchSize", "NEWS_AI_ANALYSIS_WORKER_MAX_BATCH_SIZE", "2"),
        "newsAiAnalysisBacklogScaleThreshold": value("newsAiAnalysisBacklogScaleThreshold", "NEWS_AI_ANALYSIS_BACKLOG_SCALE_THRESHOLD", "6"),
        ...
        "investmentCalendarFedFomcEnabled": value("investmentCalendarFedFomcEnabled", "INVESTMENT_CALENDAR_FED_FOMC_ENABLED", "1"),
        "investmentCalendarFedDecisionTimeEt": value("investmentCalendarFedDecisionTimeEt", "INVESTMENT_CALENDAR_FED_DECISION_TIME_ET", "14:00"),
        "investmentCalendarBlsMacroEnabled": value("investmentCalendarBlsMacroEnabled", "INVESTMENT_CALENDAR_BLS_MACRO_ENABLED", "1"),
        "investmentCalendarBlsFredFallbackEnabled": value("investmentCalendarBlsFredFallbackEnabled", "INVESTMENT_CALENDAR_BLS_FRED_FALLBACK_ENABLED", "1"),
        "investmentCalendarBeaMacroEnabled": value("investmentCalendarBeaMacroEnabled", "INVESTMENT_CALENDAR_BEA_MACRO_ENABLED", "1"),
        ...
        "ecosApiKey": value("ecosApiKey", "ECOS_API_KEY"),
        "kosisApiKey": value("kosisApiKey", "KOSIS_API_KEY"),
        "krxOpenApiKey": value("krxOpenApiKey", "KRX_OPEN_API_KEY"),
        "opendartApiKey": value("opendartApiKey", "OPENDART_API_KEY"),
        "publicDataPortalServiceKey": value("publicDataPortalServiceKey", "PUBLIC_DATA_PORTAL_SERVICE_KEY"),
        "fxRates": value("fxRates", "FX_RATES", "KRW=1\nUSD=1400"),
        "portfolioValuationBasis": value("portfolioValuationBasis", "PORTFOLIO_VALUATION_BASIS", "broker-net"),
    }
