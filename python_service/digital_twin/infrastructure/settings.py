...
def runtime_settings() -> Dict[str, str]:
    ...
    settings = {
        ...
        "kisMarketSignalCacheMinutes": value("kisMarketSignalCacheMinutes", "KIS_MARKET_SIGNAL_CACHE_MINUTES", "10"),
        ...
        "marketDataCollectionIntervalSeconds": value("marketDataCollectionIntervalSeconds", "MARKET_DATA_COLLECTION_INTERVAL_SECONDS", "3600"),
