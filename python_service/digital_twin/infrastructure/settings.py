...
def runtime_settings(fast_operational_read: bool = False) -> Dict[str, str]:
    ...
    settings = {
        ...
        "reasoningEnginePromotionMinimumComparisons": value("reasoningEnginePromotionMinimumComparisons", "REASONING_ENGINE_PROMOTION_MINIMUM_COMPARISONS", "20"),
        "reasoningEnginePromotionMinimumSymbols": value("reasoningEnginePromotionMinimumSymbols", "REASONING_ENGINE_PROMOTION_MINIMUM_SYMBOLS", "5"),
