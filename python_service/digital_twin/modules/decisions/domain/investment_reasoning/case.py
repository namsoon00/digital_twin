...
from digital_twin.modules.decisions.domain.investment_reasoning.contracts import AIJudgmentResult, FACT_DELTA_VERSION, FinalDecision, FactDelta, HypothesisRecord, InferenceResult, DecisionSynthesis, INVESTMENT_REASONING_CONTRACT_VERSION
...
CASE_SUPERSEDED = "SUPERSEDED"
CASE_EXPIRED = "EXPIRED"
...
CASE_DISPOSITION_STAGES = {CASE_SUPPRESSED, CASE_SUPERSEDED, CASE_EXPIRED}

CASE_TRANSITIONS = {
    CASE_CREATED: {CASE_INPUT_READY, CASE_DEFERRED, CASE_BLOCKED, CASE_FAILED, *CASE_DISPOSITION_STAGES},
    CASE_DEFERRED: {CASE_INPUT_READY, CASE_DEFERRED, CASE_BLOCKED, CASE_FAILED, *CASE_DISPOSITION_STAGES},
    CASE_INPUT_READY: {CASE_INFERENCE_COMPLETED, CASE_DEFERRED, CASE_BLOCKED, CASE_FAILED, *CASE_DISPOSITION_STAGES},
    CASE_INFERENCE_COMPLETED: {CASE_HYPOTHESES_READY, CASE_BLOCKED, CASE_FAILED, *CASE_DISPOSITION_STAGES},
    CASE_HYPOTHESES_READY: {CASE_DECISION_SYNTHESIZED, CASE_AI_PENDING, CASE_VALIDATED, CASE_COMPLETED, CASE_BLOCKED, CASE_FAILED, *CASE_DISPOSITION_STAGES},
    CASE_DECISION_SYNTHESIZED: {CASE_AI_PENDING, CASE_VALIDATED, CASE_COMPLETED, CASE_BLOCKED, CASE_FAILED, *CASE_DISPOSITION_STAGES},
    CASE_AI_PENDING: {CASE_AI_COMPLETED, CASE_VALIDATED, CASE_BLOCKED, CASE_FAILED, *CASE_DISPOSITION_STAGES},
    CASE_AI_COMPLETED: {CASE_VALIDATED, CASE_BLOCKED, CASE_FAILED, *CASE_DISPOSITION_STAGES},
    CASE_VALIDATED: {CASE_COMPLETED, CASE_PUBLISHED, CASE_BLOCKED, CASE_FAILED, *CASE_DISPOSITION_STAGES},
    CASE_COMPLETED: set(),
    CASE_PUBLISHED: set(),
    CASE_BLOCKED: set(),
    CASE_FAILED: set(),
