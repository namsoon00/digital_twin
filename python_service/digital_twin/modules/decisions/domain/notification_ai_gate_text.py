...
from digital_twin.modules.decisions.domain.notification_ai import active_investment_opinion_value, line_value, relation_context_value
from digital_twin.modules.decisions.domain.notification_ai_gate_contracts import ACTION_TEXT_REPLACEMENTS, VALID_ACTIONS
...
def customer_visible_ai_text(value: object) -> str:
    ...
    from digital_twin.modules.read_models.contracts import FIELD_LABELS, customer_safe_text
