...
from digital_twin.infrastructure.external_signal_utils import DISABLED_SETTING_VALUES, default_text_fetcher, external_call_target, guarded_external_call, guarded_int_setting
