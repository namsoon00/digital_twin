...
from digital_twin.modules.notifications.contracts import CRYPTO_ONTOLOGY_SIGNAL, EXTERNAL_CRYPTO_MOVE, EXTERNAL_DART_DISCLOSURE, EXTERNAL_EQUITY_MOVE, EXTERNAL_MACRO_SHIFT, HOLDING_TIMING, INVESTMENT_INSIGHT, MARKET_OBSERVATION, NEWS_DIGEST, PORTFOLIO_HOLDINGS_SNAPSHOT, MODEL_BUY, MODEL_SELL, MONITOR_DECISION_CHANGE, MONITOR_PNL_CHANGE, MONITOR_POSITION_CHANGE, MONITOR_TREND_CHANGE, MONITOR_VALUE_CHANGE, WATCHLIST_BUY_CANDIDATE, WATCHLIST_ONTOLOGY_SIGNAL, WATCHLIST_QUOTE
