...
from digital_twin.modules.model_registry.domain.ontology_tbox import CLASS_DEFS, tbox_class_def
...
CORE_LANGUAGE_TERMS = [
    ...
    InvestmentLanguageTerm(
        ...
        "decision-concept",
        "확인 단계",
        "현재 자료를 평소 관찰, 변화 관찰, 조건 확인, 대응 준비, 즉시 재확인, 판단 보류 중 하나로 나타냅니다.",
        _level_renderings("확인 단계", "지금 얼마나 주의해서 봐야 하는지"),
        ["확인 필요 점수", "관계 점수", "관계 강도"],
        ["review level", "relation score", "relationStrength"],
    ),
    InvestmentLanguageTerm(
