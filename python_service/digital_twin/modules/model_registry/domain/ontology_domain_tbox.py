...
from digital_twin.modules.model_registry.domain.ontology_tbox_contracts import TBoxBoundedContext, TBoxClassDef, TBoxRelationDef, TBoxRuleDef
...
DOMAIN_CLASS_DEFS = [
    ...
    TBoxClassDef("SectorExposure", "risk-exposure", "섹터 노출", parent="ExposureSnapshot"),
    TBoxClassDef("CurrencyExposure", "risk-exposure", "통화 노출", parent="ExposureSnapshot"),
    TBoxClassDef("CashExposure", "risk-exposure", "현금 노출", parent="ExposureSnapshot"),
    ...
    TBoxClassDef("InvestmentInsightAssessment", "decision-intelligence", "근거 기반 방향성·인과·투자 의미 평가"),
...
DOMAIN_RELATION_DEFS = [
    ...
    TBoxRelationDef("PRODUCES_AI_INSIGHT", "decision-intelligence", "decision-intelligence", "decision-intelligence"),
...
DOMAIN_RULE_DEFS = [
    ...
    TBoxRuleDef("market evidence profiles distinguish stale, session unavailable, temporary failure, provider unsupported, and not applicable data before an inference rule is eligible", "market-observation"),
    TBoxRuleDef("a decision follow-up condition is scheduled only when its field is observable in the subject market evidence profile", "decision-intelligence"),
...
CLASS_CONTEXT_OVERRIDES: Dict[str, str] = {
    ...
    "SecurityListing": "asset-knowledge",
    ...
    "MarketEvidenceProfile": "market-observation",
    "KREquityEvidenceProfile": "market-observation",
    "USEquityEvidenceProfile": "market-observation",
    "ADREvidenceProfile": "market-observation",
    "CryptoEvidenceProfile": "market-observation",
    "DataAvailabilityAssessment": "market-observation",
    ...
    "ShareholderRightEvent": "research-evidence",
    ...
    "HypothesisTemplate": "decision-intelligence",
    "RuleClaimContract": "decision-intelligence",
    "MarketHypothesisClaim": "decision-intelligence",
    "RiskInvariantClaim": "decision-intelligence",
    "ExecutionFeasibilityClaim": "decision-intelligence",
    "DataReliabilityClaim": "decision-intelligence",
    "CausalContextClaim": "decision-intelligence",
    "HypothesisQualificationPolicy": "outcome-learning",
    "PredictionTarget": "decision-intelligence",
    "ExpectedOutcome": "decision-intelligence",
    "CompetingHypothesisFamily": "decision-intelligence",
    "FalsificationCondition": "decision-intelligence",
    ...
    "DecisionFollowUpCondition": "decision-intelligence",
    "HypothesisOutcomeContract": "outcome-learning",
    "HypothesisOutcomeCriterion": "outcome-learning",
    "ObservedOutcome": "outcome-learning",
    "OutcomeCriterionObservation": "outcome-learning",
    "HypothesisOutcomeAssessment": "outcome-learning",
