...
from digital_twin.modules.model_registry.domain.ontology_relation_catalog import DECISION_STAGE_DEFINITIONS
from digital_twin.modules.model_registry.domain.ontology_relation_contracts import DecisionStageDefinition
