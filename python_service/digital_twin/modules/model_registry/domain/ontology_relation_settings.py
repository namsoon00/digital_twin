...
from digital_twin.modules.model_registry.domain.ontology_prompt_registry import DEFAULT_PROMPT_TEMPLATES
from digital_twin.modules.model_registry.domain.ontology_relation_contracts import AI_PROMPT_REGISTRY_VERSION, DEFAULT_RELATION_THRESHOLDS, OntologyPromptTemplate, RelationRuleDefinition
