...
from digital_twin.infrastructure.local_ai_process_guard import run_ai_prompt_command
from digital_twin.infrastructure.settings import ROOT_DIR, data_dir, runtime_settings
...
def codex_command(_requested_model: str = "", reasoning_effort: str = "") -> str:
    ...
    try:
        ...
        wait_seconds = 300
    guard = ROOT_DIR / "python_service" / "digital_twin" / "infrastructure" / "local_ai_process_guard.py"
    try:
