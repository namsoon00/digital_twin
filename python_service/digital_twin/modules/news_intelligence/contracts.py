...
_EXPORTS = {
 ...
 'source_reference_from_fact_row': ('digital_twin.modules.news_intelligence.domain.company_event', 'source_reference_from_fact_row'),
...
_EXPORTS.update({
    ...
    'build_company_driver_map': ('digital_twin.modules.news_intelligence.domain.company_drivers', 'build_company_driver_map'),
    ...
    'evaluate_causal_attribution': ('digital_twin.modules.news_intelligence.domain.causal_attribution', 'evaluate_causal_attribution'),
