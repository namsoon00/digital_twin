...
from digital_twin.modules.model_registry.contracts import WATCHLIST_ALLOWED_ACTIONS, WATCHLIST_TARGET_ROLE
    ...
    def to_dict(self) -> Dict[str, object]:
        ...
        return {
            ...
            **states,
            ...
            "newsEligibility": dict(payload.get("newsEligibility") or {}),
