...
from digital_twin.modules.news_intelligence.contracts import NEWS_MATERIALITY_STATE_LABELS, NEWS_RELEVANCE_STATE_LABELS, NEWS_SOURCE_TRUST_STATE_LABELS, news_state_payload
from digital_twin.modules.reasoning.contracts import CHANGE_STATE_LABELS, CONFLICT_STATE_LABELS, DATA_STATE_LABELS, REVIEW_LEVEL_LABELS, VALIDATION_STATE_LABELS, review_level_for
