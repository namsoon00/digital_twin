...
from digital_twin.modules.notifications.domain.alert_formatting import signed_pct
from digital_twin.modules.market_data.contracts import external_api_source_line
from digital_twin.modules.notifications.domain.message_types import MARKET_OBSERVATION, MESSAGE_TYPE_EMOJIS, MESSAGE_TYPE_LABELS, ONTOLOGY_LAB_EXPERIMENT, OPERATOR_REASONING_REPORT, TRIGGER_SUMMARIES
from digital_twin.modules.notifications.domain.notification_ontology_sections import CURVE_REGIME_LABELS, FX_REGIME_LABELS, RATE_REGIME_LABELS, ai_prompt_lines, append_unique_lines, beginner_relation_decision_line, beginner_rule_explanation, block_from_lines, fact_number, fact_number_text, fx_fact_line, has_fact_value, macro_context_lines, missing_data_lines, notification_ai_opinion_lines, notification_ai_opinion_payload, notification_data_lines, ontology_missing_data, ontology_relation_context, ontology_relation_contexts, ontology_rule_lines, rate_fact_line, relation_axis_summary_lines, rule_value, source_fact_rows, telegram_block_from_lines
from digital_twin.modules.notifications.domain.notification_text_formatting import BEGINNER_FRIENDLY_REPLACEMENTS, DATA_LABEL_ORDER, DATA_LABEL_PREFIXES, FOOTER_DATA_LABELS, ONTOLOGY_INTERNAL_DATA_PREFIXES, SEPARATE_DATA_LABELS, absolute_beginner_friendly_text, beginner_friendly_text, criterion_row, criterion_rows, data_pair_text, data_value, dominant_signed_direction, first_data_text, formatted_data_rows, grouped_data_rows, html_bullet, is_ontology_internal_data_line, ordered_data_entries, plain_bullet, plain_data_rows, signed_direction, split_data_line, split_label_value, telegram_data_rows, text_parts_from_value, title_from_change
from digital_twin.modules.notifications.domain.notification_title_rules import compact_action_title, current_utc_iso, event_criterion_lines, event_generated_at, first_line_containing, has_entry_wait_signal, has_investment_loss_signal, has_investment_profit_signal, inferred_criterion_lines, investment_insight_decision_blob, investment_insight_is_holding, investment_insight_signal_blob, notification_title_headline, notification_title_icon, percent_text, raw_lines_with_reference_date, reference_date_text
from digital_twin.modules.notifications.domain.notifications import notification_debug_number
...
from digital_twin.modules.notifications.domain.notification_title_policy import investment_notification_title
from digital_twin.modules.notifications.domain.operational_notification_presentation import operational_message_start_badge, operational_presentation_context
from digital_twin.modules.portfolio.contracts import AlertEvent
from digital_twin.modules.notifications.domain.notification_signal_classification import notification_signal_categories
