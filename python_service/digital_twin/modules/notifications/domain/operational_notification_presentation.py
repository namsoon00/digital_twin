...
from digital_twin.modules.notifications.domain.message_types import EXTERNAL_DATA_CONNECTION, MONITOR_CONNECTION, MONITOR_HEARTBEAT, ONTOLOGY_INFERENCE_MISSING, ONTOLOGY_REASONING_QUEUE, OPERATIONAL_STORAGE_CAPACITY, OPERATOR_REASONING_REPORT, WORK_HANDOFF, is_operations_delivery_message_type
