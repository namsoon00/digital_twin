...
from digital_twin.modules.portfolio.domain.snapshot_portfolio_activity import activity_payload, cash_balance_components, observed_positions, snapshot_balance_fingerprint
