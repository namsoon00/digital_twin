...
from digital_twin.modules.instruments.contracts import SecurityLine, security_lines_for_symbol
...
from digital_twin.modules.portfolio.domain.valuation.evidence import FUNDAMENTAL_MODEL_VERSION, collect_earnings_observations, collect_multiple_observations, earnings_scenario, fair_value_from_evidence, multiple_evidence_band
...
def ai_valuation_proposal_rows(
    ...
    # Legacy public entry point. Model selection belongs to the registry so
    # adding one instrument family does not modify the orchestration service.
    from digital_twin.modules.portfolio.domain.valuation.registry import registered_valuation_model_rows

    return registered_valuation_model_rows(position, external_signals, settings)
