...
from digital_twin.modules.reasoning.domain.abox_lifecycle.contracts import RELATION_ENDPOINT_BINDING_VERSION, SCOPE_NODE_INVENTORY_VERSION, ABoxChangeSet, ManifestPatchPlan, PatchPlanValidation, PatchPlanViolation, RelationPatchDirective, ScopePlanEntry
