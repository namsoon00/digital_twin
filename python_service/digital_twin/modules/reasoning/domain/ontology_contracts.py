...
class PortfolioOntology:
    ...
    def to_dict(self) -> Dict[str, object]:
        from digital_twin.modules.reasoning.domain.ontology_prompting import ONTOLOGY_PROMPT_VERSION, build_ai_inference_packet, inferencebox_payload, rulebox_payload
