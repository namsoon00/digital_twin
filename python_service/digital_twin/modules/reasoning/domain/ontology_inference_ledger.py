...
from digital_twin.modules.reasoning.domain.ontology_decision_state import conflict_state_from_roles, evidence_role_from_relation, semantic_relation_sort_key
