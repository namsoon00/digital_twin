...
from digital_twin.modules.market_data.contracts import age_minutes
from digital_twin.modules.market_data.contracts import number
from digital_twin.modules.reasoning.domain.ontology_contracts import OntologyBelief, OntologyEntity, OntologyEvidence, OntologyRelation, PortfolioOntology, entity_id
from digital_twin.modules.reasoning.domain.ontology_decision_state import ACTION_LEVEL_RANK, DATA_STATE_LABELS, REVIEW_LEVEL_LABELS, conflict_state_from_roles, review_level_for
from digital_twin.modules.reasoning.domain.ontology_change_impact import rule_dependency_profile
from digital_twin.modules.model_registry.contracts import GRAPH_REASONER_VERSION, HOLDING_TARGET_ROLE, WATCHLIST_ACTION_POLICY, WATCHLIST_ALLOWED_ACTIONS, WATCHLIST_BLOCKED_ACTIONS, WATCHLIST_TARGET_ROLE, GraphInferenceRule
from digital_twin.modules.model_registry.contracts import rule_domain_manifest
from digital_twin.modules.reasoning.domain.ontology_schema import abox_relation_properties
...
def materialize_rule_inference(
    ...
    for index, derivation in enumerate(rule.derivations):
        ...
        graph.entities.append(OntologyEntity(target_id, target_label, derivation.target_kind, inference_properties({
            ...
            "decisionEffect": str(derivation.decision_effect or ""),
