...
from digital_twin.modules.reasoning.domain.ontology_contracts import OntologyBelief, OntologyEvidence, OntologyRelation, PortfolioOntology
from digital_twin.modules.reasoning.domain.ontology_schema import ontology_abox, ontology_tbox
from digital_twin.modules.reasoning.domain.ontology_decision_state import evidence_role_from_relation, without_aggregate_decision_fields
from digital_twin.modules.model_registry.contracts import BOUNDED_CONTEXTS, bounded_contexts_payload
from digital_twin.modules.portfolio.contracts import PortfolioSummary
