...
from digital_twin.modules.model_registry.contracts import BOUNDED_CONTEXTS, CLASS_DEFS, RELATION_DEFS, TBOX_CLASSES, TBOX_REASONING_RULES, TBOX_RELATION_TYPES, bounded_contexts_payload, class_definitions_payload, relation_definitions_payload, rule_definitions_payload, tbox_class_def, tbox_class_materialization_policy, tbox_materialization_box, tbox_relation_def, tbox_relation_materialization_policy
from digital_twin.modules.model_registry.contracts import ONTOLOGY_DOMAIN_TBOX_VERSION, tbox_domain_validation


ONTOLOGY_TBOX_VERSION = "investment-tbox-v13-official-company-reference"
