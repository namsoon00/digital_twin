...
from digital_twin.modules.reasoning.domain.abox_lifecycle import ABoxChangeSet, finalize_manifest_patch_plan
from digital_twin.modules.reasoning.domain.abox_lifecycle.contracts import RELATION_ENDPOINT_BINDING_VERSION, SCOPE_NODE_INVENTORY_VERSION, relation_lifecycle_for_scope
from digital_twin.modules.reasoning.domain.ontology_change_impact import DEPENDENCY_FINGERPRINT_VERSION, SYMBOL_SCOPE_FAMILIES, family_for_field, family_for_entity, family_for_relation, macro_scope_id, pack_semantic_dependency_fingerprints, scope_family, scope_source_symbols, scope_symbol, symbol_scope_id, unpack_semantic_dependency_fingerprints
...
from digital_twin.modules.reasoning.domain.ontology_fact_slots import select_fact_slot_scope_ids
from digital_twin.modules.reasoning.domain.ontology_projection_fingerprint import VOLATILE_LIFECYCLE_KEYS, stable_value
from digital_twin.modules.reasoning.domain.ontology_worlds import world_scoped_scope_id
