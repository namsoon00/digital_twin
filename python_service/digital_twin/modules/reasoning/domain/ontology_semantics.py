...
from digital_twin.modules.model_registry.contracts import CLASS_DEFS, RELATION_DEFS, tbox_class_def
...
CORE_RELATION_ENDPOINTS: Dict[str, Tuple[Sequence[str], Sequence[str]]] = {
    ...
    "HAS_LISTING": (("Company", "Instrument", "Security"), ("SecurityListing",)),
    "LISTED_ON": (("SecurityListing",), ("Market",)),
    "HAS_SHARE_CLASS": (("Instrument", "Security"), ("ShareClass",)),
    "AFFILIATED_WITH": (("Company",), ("Company",)),
    "CONTROLS": (("Company",), ("Company",)),
    "USES_MARKET_BENCHMARK": (("Instrument", "Security"), ("Index",)),
    "HAS_CORPORATE_ACTION": (("Company", "Instrument", "Security"), ("CorporateAction",)),
    "APPLIES_TO_SECURITY": (("CorporateAction",), ("Instrument", "Security", "ShareClass")),
