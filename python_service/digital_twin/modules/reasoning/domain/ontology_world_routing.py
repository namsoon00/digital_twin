...
from digital_twin.modules.reasoning.domain.ontology_worlds import ONTOLOGY_WORLD_PARTITION_VERSION, account_overlay_partition_id, instrument_premise_partition_id, macro_context_partition_id
