...
class GraphMaintenanceGenerationsStore(Protocol):
    ...
    def abox_projection_marker_rows(self, world_id: str='', snapshot_id: str='', limit: int=0) -> List[Dict[str, object]]:
        ...
    ...
    def box_manifest_delete_batch_query(self, box: str, manifest_id: str, type_label: str, batch_size: int, world_id: str='') -> str:
        ...

    def box_manifest_instance_exists(self, driver, imported, box: str, manifest_id: str, type_label: str, world_id: str='') -> bool:
        ...

    def box_snapshot_delete_batch_query(self, box: str, snapshot_id: str, type_label: str, batch_size: int) -> str:
        ...

    def box_snapshot_external_relation_references(self, driver, imported, box: str, snapshot_id: str, limit: int=5) -> List[Dict[str, object]]:
        ...

    def box_snapshot_instance_exists(self, driver, imported, box: str, snapshot_id: str, type_label: str) -> bool:
        ...
    ...
    def prune_inactive_scoped_abox_manifests_in_driver(self, driver, imported, active_manifest_id: str='', keep_inactive_count: int=None, max_manifests: int=None, max_delete_batches: int=None, delete_batch_size: int=None, world_id: str='', max_duration_seconds: int=None) -> Dict[str, object]:
        ...
