...
class GraphMaintenanceManifestsStore(Protocol):
    ...
    def delete_worldview_manifest_markers_batch(self, driver, imported, manifest_ids: Iterable[str], world_id: str='') -> Dict[str, object]:
        ...

    def discard_scoped_abox_manifest_in_driver(self, driver, imported, manifest_id: str, protected_generation_ids: Iterable[str]=None, world_id: str='', max_delete_batches: int=None, delete_batch_size: int=None) -> Dict[str, object]:
        ...
