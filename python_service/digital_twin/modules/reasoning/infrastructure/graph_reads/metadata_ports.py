...
class GraphReadsMetadataStore(Protocol):
    ...
    def active_inference_generation_marker_rows(self, world_id: str='', limit: int=1) -> List[Dict[str, object]]:
        ...

    def active_worldview_manifest_pointer_identity_rows(self, world_id: str='', limit: int=0) -> List[Dict[str, object]]:
        ...
    ...
    def read_entity_rows(self, boxes: Iterable[str]=None, limit: int=0, world_id: str='', snapshot_id: str='') -> List[Dict[str, object]]:
        ...

    def read_relation_rows(self, boxes: Iterable[str]=None, limit: int=0, world_id: str='', snapshot_id: str='') -> List[Dict[str, object]]:
        ...
    ...
    def scoped_abox_metadata_from_manifest_marker(self, marker: Dict[str, object]) -> Dict[str, object]:
        ...

    def worldview_manifest_marker_identity_rows(self, world_id: str='', manifest_id: str='', limit: int=0) -> List[Dict[str, object]]:
        ...

    def worldview_manifest_marker_rows(self, world_id: str='', manifest_id: str='', limit: int=0) -> List[Dict[str, object]]:
        ...
