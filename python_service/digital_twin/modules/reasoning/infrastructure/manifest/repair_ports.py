...
class ManifestRepairStore(Protocol):
    ...
    def node_rows(self, graph: PortfolioOntology, include_external_relation_endpoints: bool=False) -> List[Dict[str, object]]:
        ...

    def open_driver(self, imported, request_timeout_seconds: float=None):
        ...

    def rebuild_active_manifest_native_rule_evidence_read_index(self, active_metadata: Dict[str, object], world_id: str='') -> Dict[str, object]:
        ...
    ...
    def replace_scoped_manifest_marker_graph(self, marker_graph: PortfolioOntology) -> Dict[str, object]:
        ...
