...
class ProjectionLockLeaseStore(Protocol):
    ...
    def delete_scoped_abox_write_lease(self, driver, imported, lease: Dict[str, object]) -> Dict[str, object]:
        ...
    ...
    def scoped_abox_write_lease_graph(self, owner: str, manifest_id: str='', lease_seconds: int=0, world_id: str='') -> Tuple[PortfolioOntology, Dict[str, object]]:
        ...
