...
def scoped_abox_write_lease_seconds(_store: ProjectionLockPolicyStore, settings: Dict[str, object]=None, *, _bindings: ProjectionLockPolicyRuntime) -> int:
...
def typedb_projection_coordinator_enabled(_store: ProjectionLockPolicyStore, settings: Dict[str, object]=None, *, _bindings: ProjectionLockPolicyRuntime) -> bool:
    """Whether one physical TypeDB writer coordinates logical worlds."""
    value = str((settings or _bindings.runtime_settings()).get(
...
def typedb_projection_coordinator_lease_seconds(_store: ProjectionLockPolicyStore, settings: Dict[str, object]=None, *, _bindings: ProjectionLockPolicyRuntime) -> int:
...
def typedb_projection_coordinator_retry_seconds(_store: ProjectionLockPolicyStore, settings: Dict[str, object]=None, *, _bindings: ProjectionLockPolicyRuntime) -> int:
