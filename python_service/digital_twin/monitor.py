...
from .config import data_dir, parse_assignments, read_json, runtime_settings, write_private_json
from .models import AccountSnapshot, AlertEvent
...
class RealtimeMonitor:
    ...
    def apply_cadence(self, events: List[AlertEvent], store: MonitorStore, force: bool = False) -> List[AlertEvent]:
        if force:
            return events
