...
class PythonServiceTests(unittest.TestCase):
    ...
    def test_kis_market_signal_provider_enriches_kr_positions(self):
        ...
        self.assertEqual("business-date-only", enriched.market_signal_coverage["investor"]["sourceTimestampState"])
    ...
    def test_kis_market_signal_provider_prefers_live_during_market_hours(self):
        ...
        self.assertEqual("rest-reference", positions[0].market_signal_coverage["investor"]["cadence"])
        self.assertEqual("reference-only", positions[0].market_signal_coverage["investor"]["freshnessStatus"])
        self.assertIs(False, positions[0].market_signal_coverage["investor"]["aiUsableAsStrongEvidence"])
        self.assertIs(True, positions[0].market_signal_coverage["investor"]["judgementEvidenceUsable"])
