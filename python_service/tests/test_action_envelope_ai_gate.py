                ...
                "hypotheses": [
                    {
                        ...
                        "causalPathIds": ["trace:price:NVDA"],
                        "approvalStatus": "approved-active",
                        "verificationStatus": "typedb-current-generation",
                        "status": "active",
                        "scopeState": "market-shared",
                        "marketHypothesisId": "market-hypothesis:NVDA:support",
                        "inferenceGenerationId": "generation:NVDA:1",
                        "knowledgeBasis": {
                            "requiresHypothesis": True,
                            "decisionEligibility": "conditional",
                        },
                        "claimContract": {
                            "claimContractId": "claim:entry:confirmed",
                    ...
                    },
                    {
                        ...
                        "causalPathIds": ["trace:risk:NVDA"],
                        "approvalStatus": "approved-active",
                        "verificationStatus": "typedb-current-generation",
                        "status": "active",
                        "scopeState": "market-shared",
                        "marketHypothesisId": "market-hypothesis:NVDA:risk",
                        "inferenceGenerationId": "generation:NVDA:1",
                        "knowledgeBasis": {
                            "requiresHypothesis": True,
                            "decisionEligibility": "conditional",
                        ...
                        "claimContract": {
                            "claimContractId": "claim:entry:risk",
                            "claimType": "market-hypothesis",
                            "ruleId": "graph.entry.risk.v1",
                        },
                    },
                    {
