...
class ExistingApiOntologyMaterializationTests(unittest.TestCase):
    ...
    def test_existing_api_payloads_materialize_investment_world_objects(self):
        ...
        self.assertNotIn("CorporateAction", tbox_classes)
        self.assertIn("RetrievedDocument", tbox_classes)
        self.assertNotIn("RegulatoryEvent", tbox_classes)
        ...
        self.assertNotIn("corporate-action", kinds)
        self.assertIn("retrieved-document", kinds)
        self.assertNotIn("regulatory-event", kinds)
