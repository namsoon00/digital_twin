...
class OntologyValidatorTests(unittest.TestCase):
    ...
    def test_portfolio_ontology_materializes_crypto_macro_and_valuation_contexts(self):
        ...
        self.assertIn("active-valuation", kinds)
        self.assertIn("valuation-review", kinds)
        ...
        self.assertIn("HAS_ACTIVE_VALUATION", relation_types)
        self.assertIn("AWAITS_USER_REVIEW", relation_types)
