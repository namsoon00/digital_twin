...
class OntologyValidatorTests(unittest.TestCase):
    ...
    def test_portfolio_ontology_materializes_crypto_macro_and_valuation_contexts(self):
        ...
        self.assertIn("interest-rate", kinds)
        self.assertIn("yield-curve", kinds)
        ...
        self.assertIn("HAS_RATE_SENSITIVITY", relation_types)
        self.assertIn("HAS_VALUATION", relation_types)
        self.assertNotIn("macro-regime", kinds)
        self.assertNotIn("HAS_MACRO_REGIME", relation_types)
    ...
    def test_tbox_contains_valuation_and_ai_decision_contracts(self):
        ...
        for relation_type in [
            ...
            "USES_REPORTING_BASIS",
            "HAS_VALUATION_DATA_QUALITY",
            "HAS_VALUATION_REGIME",
