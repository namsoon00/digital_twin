...
function checkWorkflowConsoleContract() {
  ...
  assertOk(
    code.indexOf("function notePageScrollActivity") >= 0 &&
      ...
      code.indexOf("if (!patchedDashboard) restoreRenderedPageScrollPositionAfterLayout(renderedScrollPosition)") >= 0 &&
  ...
  assertOk(
    code.indexOf("function renderInvestmentCalendarCandidateConfirmation") >= 0 &&
      ...
      indexHtml.indexOf("styles.css?v=20260815-notification-disclosure-state-v1") >= 0 &&
      indexHtml.indexOf("app-default-settings.js?v=20260815-notification-disclosure-state-v1") >= 0 &&
      indexHtml.indexOf("app.js?v=20260815-notification-disclosure-state-v1") >= 0,
