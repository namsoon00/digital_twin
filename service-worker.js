const SHELL_CACHE = "orbit-alpha-shell-20260824-decision-explanation-v1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.webmanifest",
  "./favicon.svg",
  "./styles.css?v=20260824-decision-explanation-v1",
  "./app-default-settings.js?v=20260821-stable-share-v1",
  "./app.js?v=20260824-decision-explanation-v1",
